...
public class MediatorUtil {
    ...
    /**
     * @param var
     * @return true if var is not between quotes AND is not a number false
     *         otherwise
     */
     ...
     * @throws MediatorException
     */
    public static String getFileAsString(BufferedReader file)
	    throws MediatorException {
	String domainStr = "";
     ...
     * @throws MediatorException
     */
    public static String getFileAsStringFromResource(String fileAsResource,
	    Class<?> theClass) throws MediatorException {
