...
public class MediatorConstants {
    ...
    // replaced with space; not used at this time; if needed uncomment in
    // SourceSchema and SourceAttribute
    ...
    // jmora20101007
    public static final String[] BuiltInPredicates = { EQUALS, NOT_EQUAL1,
	    NOT_EQUAL2, LESS_THAN_EQ, LESS_THAN, GREATER_THAN_EQ, GREATER_THAN,
	    LIKE, IS_NULL, ISNOT_NULL };

    // before, I was using hashCode(), but if I do this I can't reproduce the
    // output queries for Junit tests
    /**
