...
public class DomainAttribute {
    ...
    /**
     * Supported Attribute Types: STRING, NUMBER, OTHER
     */
    ...
    /**
     * true if the name has illegal chars that need to be escaped in the SQL
     * query
     */
     ...
     * 
     * @return true if this attribute is a number false otherwise
     */
