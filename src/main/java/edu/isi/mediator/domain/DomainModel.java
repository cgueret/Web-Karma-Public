...
public class DomainModel {
    ...
    // jmora 072310
    /**
     * @return all domain schema names
     */
    ...
    /**
     * @return all GAV rules (GAV rules may contain UAC rules)
     */
     ...
     * @param name
     *            name of rule head
     * @return the LAV rule with the given name, null if the rule was not found.
     */
     ...
     * @param name
     *            name of rule head
     * @return the GAV rule with the given name, null if the rule was not found.
     */
     ...
     * @param name
     *            source schema name
     * @return the source schema with specified name
     */
     ...
     * @param name
     *            domain schema name
     * @return the domain schema with specified name
     */
     ...
     * @return the attribute names of a specific domain schema
     * @throws MediatorException
     */
    public ArrayList<String> getDomainColumnNames(String name)
	    throws MediatorException {
    ...
    /**
     * Returns true if attribute domainAttr belongs to domain concept
     * domainTable
     * 
     * @param domainTable
     *            domain schema name
     * @param domainAttr
     *            attribute name
     * @return return true if attribute domainAttr belongs to domain concept
     *         domainTable
     * @throws MediatorException
     */
    public boolean isValidDomainAttr(String domainTable, String domainAttr)
	    throws MediatorException {
	if (domainTable == null) {
	...
	if (ds == null)
	    throw new MediatorException("Domain concept " + domainTable
		    + " does not exist.");
