...
public class SimpleGraph {
    ...
    /**
     * Generates a graph given a list of Predicates. Only considers Joins at
     * this time.
     */
     ...
     * @return a new graph with a join node added to graphSoFar
     */
    private SimpleBaseNode buildJoin(RelationPredicate rel,
	    SimpleBaseNode graphSoFar) {
	System.out.println("Join with " + rel);
	/*
	 * System.out.println("Build join with " + source); if(joinSoFar!=null)
