...
/**
 * Main Ontology Mapper Class. Reads a configuration file called
 * ontologysettings.config located in the top level directory.
 * 
...
public class OntologyMapperTest {
    ...
    private static final MediatorLogger logger = MediatorLogger
	    .getLogger(OntologyMapperTest.class.getName());
	...
	try {
	    ...
	    // String s =
	    // m.getAlignedRdf("http://www.dovetail.org/wits/SYSTEM.FACILITY/23434");
	    // m.getAlignedRdf("http://www.dovetail.org/wits/SYSTEM.FACILITY/23434",
	    // "C:/z.out");
	...
	if (connectStr == null || dbDriver == null || modelName == null) {
	    throw new MediatorException(
		    "Settings file should contain CONNECT_STR, DB_DRIVER, DB_NAME and MODEL_NAME");
	}
    }
