...
public class RDFUtil {
    ...
    private static final MediatorLogger logger = MediatorLogger
	    .getLogger(RDFUtil.class.getName());

    /**
     * Write namespaces to output.
     */
    static public void setNamespace(Map<String, String> sourceNamespaces,
    ...
    /**
     * Return the prefix for a given namespace IF the map contains only one
     * entry.
     * 
     * @param namespaces
    ...
    /**
     * Returns the table name from a given URI. Table name appears as:
     * DBNAME.TableName/ or /TableName/
     * 
     * @param uri
	...
	if (tokens.length < 2)
	    throw new MediatorException(
		    "The URI must contain a table name either as DBNAME.TableName/ or /TableName/.");
     ...
     * @throws MediatorException
     */
    static public String getTableNameOracle(String uri)
	    throws MediatorException {
	...
	if (ind1 < 0) {
	    throw new MediatorException(
		    "The URI must contain a table name that starts with \".\"");
	}
	int ind2 = uri.indexOf("/", ind1);
	if (ind2 < 0) {
	    throw new MediatorException(
		    "The subject URI must contain a table name that starts with \".\" and ends with \"/\". /DBName.TableName/");
	}
    ...
    /**
     * Returns the database name from a given URI. database name appears as:
     * /DBNAME.TableName/
     * 
     * @param uri
     *            the uri (it is a URI generated by D2R)
     ...
     * @throws MediatorException
     */
    static public String getDatabaseNameOracle(String uri)
	    throws MediatorException {
