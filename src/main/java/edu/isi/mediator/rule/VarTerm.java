...
public class VarTerm extends Term {
    ...
    /**
     * @param b
     *            needsBinding value of the associated
     *            {@link edu.isi.mediator.gav.source.SourceAttribute}
     * @return true if the source attribute associated with this term needs
     *         binding, false otherwise.
     */
    /*
     * (non-Javadoc)
     * 
