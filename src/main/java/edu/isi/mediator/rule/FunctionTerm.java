...
public class FunctionTerm extends Term {
     ...
     * @param var
     */
    public FunctionTerm(String var) {
	this.var = var;
    }

    /**
     * Constructs a FunctionTerm with the variable name "var" and query name
     * "qName"
     * 
     * @param var
     * @param queryName
     ...
     * (non-Javadoc)
     * 
     * @see edu.isi.mediator.gav.domain.Term#getFreeVar() Always returns null.
     */
	...
	if (function == null)
	    ...
	    throw new MediatorException(
		    "A variable can be assigned only to one function var="
			    + var);
	}
    }
     ...
     * (non-Javadoc)
     * 
     * @see edu.isi.mediator.gav.domain.Term#getFunction() Returns the function.
     */
     ...
     * 
     * @return true if the output of this function is a number, false otherwise.
     */
     ...
     * @param t
     *            comparison term
     * @return true if the functions in both terms are equal, false otherwise.
     */
     ...
     * (non-Javadoc)
     * 
     * @see edu.isi.mediator.gav.domain.Term#needsBinding(boolean) Returns true
     * if "b" is true, otherwise returns true if the {@link
     * edu.isi.mediator.gav.domain.FunctionPredicate} needs binding and false
     * otherwise.
     */
	...
	// unify here; there might be vars inside the function that need to be
	// unified
