...
public class RuleInterpreterTree extends TreeParser {
    public static final String[] tokenNames = new String[] { "<invalid>",
	    "<EOR>", "<DOWN>", "<UP>", "ANYNUM", "ANYTOK", "ANYTOKS", "ANYTYP",
	    "BNKTYP", "DEL", "DIGIT", "ENDTYP", "FRMB", "FRME", "FST", "INCLD",
	    "INS", "LST", "MOV", "NEWLINE", "NUM", "NUMTYP", "SRTTYP",
	    "SYBTYP", "TOKEN", "WRDTYP", "WS" };
	...
	return RuleInterpreterTree.tokenNames;
    }

    public String getGrammarFileName() {
	return "RuleInterpreterTree.g";
    }
    ...
    public final RuleInterpreterTree.rule_return rule()
	...
	try {
		...
		this.ruler.doOperation((operator1 != null ? operator1.value
			: null), (what2 != null ? what2.num : null),
    ...
    // $ANTLR start "what"
    // RuleInterpreterTree.g:49:1: what returns [String num,Vector<TNode> res] :
    // ( quantifier tokenspec | ANYTOKS );
    public final RuleInterpreterTree.what_return what()
	    throws RecognitionException {
	...
	try {
		...
		retval.num = (quantifier4 != null ? quantifier4.value : null);
    ...
    // RuleInterpreterTree.g:51:1: quantifier returns [String value] : ( ANYNUM
    // | qnum );
    public final RuleInterpreterTree.quantifier_return quantifier()
	    throws RecognitionException {
	...
	try {
		...
		_last = (CommonTree) input.LT(1);
		ANYNUM7 = (CommonTree) match(input, ANYNUM,
			FOLLOW_ANYNUM_in_quantifier107);
    ...
    // RuleInterpreterTree.g:55:1: tokenspec returns [Vector<TNode> res] :
    // singletokenspec[toks] ( singletokenspec[toks] )* ;
    public final RuleInterpreterTree.tokenspec_return tokenspec()
	    throws RecognitionException {
	...
	try {
	    // RuleInterpreterTree.g:57:2: ( singletokenspec[toks] (
	    // singletokenspec[toks] )* )
	    // RuleInterpreterTree.g:57:4: singletokenspec[toks] (
	    // singletokenspec[toks] )*
	    {
		root_0 = (CommonTree) adaptor.nil();
		...
		loop3: do {
		    ...
		    if ((LA3_0 == ANYTOK
			    || (LA3_0 >= ANYTYP && LA3_0 <= BNKTYP)
			    || LA3_0 == ENDTYP || (LA3_0 >= NUMTYP && LA3_0 <= WRDTYP))) {
			alt3 = 1;
		    }
    ...
    // RuleInterpreterTree.g:58:1: stokenspec returns [Vector<TNode> res] :
    // singletokenspec[toks] ( singletokenspec[toks] )* ;
    public final RuleInterpreterTree.stokenspec_return stokenspec()
	    throws RecognitionException {
	...
	Vector<TNode> toks = new Vector<TNode>();
	try {
	    // RuleInterpreterTree.g:60:2: ( singletokenspec[toks] (
	    // singletokenspec[toks] )* )
	    // RuleInterpreterTree.g:60:4: singletokenspec[toks] (
	    // singletokenspec[toks] )*
	    {
		root_0 = (CommonTree) adaptor.nil();
		...
		loop4: do {
		    ...
		    if ((LA4_0 == ANYTOK
			    || (LA4_0 >= ANYTYP && LA4_0 <= BNKTYP)
			    || LA4_0 == ENDTYP || (LA4_0 >= NUMTYP && LA4_0 <= WRDTYP))) {
			alt4 = 1;
		    }
    ...
    // RuleInterpreterTree.g:61:1: etokenspec returns [Vector<TNode> res] :
    // singletokenspec[toks] ( singletokenspec[toks] )* ;
    public final RuleInterpreterTree.etokenspec_return etokenspec()
	    throws RecognitionException {
	...
	Vector<TNode> toks = new Vector<TNode>();
	try {
	    // RuleInterpreterTree.g:63:2: ( singletokenspec[toks] (
	    // singletokenspec[toks] )* )
	    // RuleInterpreterTree.g:63:4: singletokenspec[toks] (
	    // singletokenspec[toks] )*
	    {
		root_0 = (CommonTree) adaptor.nil();
		...
		loop5: do {
		    ...
		    if ((LA5_0 == ANYTOK
			    || (LA5_0 >= ANYTYP && LA5_0 <= BNKTYP)
			    || LA5_0 == ENDTYP || (LA5_0 >= NUMTYP && LA5_0 <= WRDTYP))) {
			alt5 = 1;
		    }
    ...
    // RuleInterpreterTree.g:65:1: singletokenspec[Vector<TNode> tokspec] : (
    // token | type );
    public final RuleInterpreterTree.singletokenspec_return singletokenspec(
	...
	try {
		...
		alt6 = 1;
	    } else if (((LA6_0 >= ANYTYP && LA6_0 <= BNKTYP) || LA6_0 == ENDTYP
    ...
    public final RuleInterpreterTree.operator_return operator()
	    throws RecognitionException {
	...
	try {
		...
		_last = (CommonTree) input.LT(1);
		DEL17 = (CommonTree) match(input, DEL,
			FOLLOW_DEL_in_operator218);
    ...
    // $ANTLR start "type"
    // RuleInterpreterTree.g:71:1: type returns [String value] : ( ANYTYP |
    // NUMTYP | WRDTYP | SYBTYP | BNKTYP | SRTTYP | ENDTYP );
    public final RuleInterpreterTree.type_return type()
	    throws RecognitionException {
	...
	try {
	    // RuleInterpreterTree.g:71:28: ( ANYTYP | NUMTYP | WRDTYP | SYBTYP
	    // | BNKTYP | SRTTYP | ENDTYP )
	    int alt7 = 7;
	    switch (input.LA(1)) {
	    case ANYTYP: {
		alt7 = 1;
		...
		_last = (CommonTree) input.LT(1);
		ANYTYP18 = (CommonTree) match(input, ANYTYP,
			FOLLOW_ANYTYP_in_type232);
		...
		_last = (CommonTree) input.LT(1);
		NUMTYP19 = (CommonTree) match(input, NUMTYP,
			FOLLOW_NUMTYP_in_type236);
		...
		_last = (CommonTree) input.LT(1);
		WRDTYP20 = (CommonTree) match(input, WRDTYP,
			FOLLOW_WRDTYP_in_type240);
		...
		_last = (CommonTree) input.LT(1);
		SYBTYP21 = (CommonTree) match(input, SYBTYP,
			FOLLOW_SYBTYP_in_type244);
		...
		_last = (CommonTree) input.LT(1);
		BNKTYP22 = (CommonTree) match(input, BNKTYP,
			FOLLOW_BNKTYP_in_type248);
		...
		_last = (CommonTree) input.LT(1);
		SRTTYP23 = (CommonTree) match(input, SRTTYP,
			FOLLOW_SRTTYP_in_type252);
		...
		_last = (CommonTree) input.LT(1);
		ENDTYP24 = (CommonTree) match(input, ENDTYP,
			FOLLOW_ENDTYP_in_type256);
    ...
    // $ANTLR start "token"
    // RuleInterpreterTree.g:73:1: token returns [String value] : ( ANYTOK |
    // TOKEN );
    public final RuleInterpreterTree.token_return token()
	    throws RecognitionException {
	...
	try {
		...
		_last = (CommonTree) input.LT(1);
		ANYTOK25 = (CommonTree) match(input, ANYTOK,
			FOLLOW_ANYTOK_in_token268);
		ANYTOK25_tree = (CommonTree) adaptor.dupNode(ANYTOK25);

		adaptor.addChild(root_0, ANYTOK25_tree);

		retval.value = "("
			+ (ANYTOK25 != null ? ANYTOK25.getText() : null) + ")";
		...
		_last = (CommonTree) input.LT(1);
		TOKEN26 = (CommonTree) match(input, TOKEN,
			FOLLOW_TOKEN_in_token273);
    ...
    // $ANTLR start "where"
    // RuleInterpreterTree.g:76:1: where returns [int spos, int epos] : start
    // end ;
    public final RuleInterpreterTree.where_return where()
	    throws RecognitionException {
	...
	try {
		...
		retval.spos = (start27 != null ? start27.xpos : 0);
		retval.epos = (end28 != null ? end28.xpos : 0);
    ...
    // RuleInterpreterTree.g:78:1: scanningOrder returns [String value] : ( FRMB
    // | FRME );
    public final RuleInterpreterTree.scanningOrder_return scanningOrder()
	    throws RecognitionException {
	...
	try {
		...
		_last = (CommonTree) input.LT(1);
		FRMB29 = (CommonTree) match(input, FRMB,
			FOLLOW_FRMB_in_scanningOrder304);
		...
		_last = (CommonTree) input.LT(1);
		FRME30 = (CommonTree) match(input, FRME,
			FOLLOW_FRME_in_scanningOrder308);
    ...
    // $ANTLR start "start"
    // RuleInterpreterTree.g:81:1: start returns [int xpos] : scanningOrder r=
    // swherequantifier[$scanningOrder.value] ;
    public final RuleInterpreterTree.start_return start()
	    throws RecognitionException {
	...
	try {
	    // RuleInterpreterTree.g:81:25: ( scanningOrder r=
	    // swherequantifier[$scanningOrder.value] )
	    // RuleInterpreterTree.g:81:28: scanningOrder r=
	    // swherequantifier[$scanningOrder.value]
	    {
		root_0 = (CommonTree) adaptor.nil();
		...
		r = swherequantifier((scanningOrder31 != null ? scanningOrder31.value
			: null));
    ...
    // $ANTLR start "end"
    // RuleInterpreterTree.g:82:1: end returns [int xpos] : scanningOrder r=
    // ewherequantifier[$scanningOrder.value] ;
    public final RuleInterpreterTree.end_return end()
	    throws RecognitionException {
	...
	try {
	    // RuleInterpreterTree.g:82:23: ( scanningOrder r=
	    // ewherequantifier[$scanningOrder.value] )
	    // RuleInterpreterTree.g:82:26: scanningOrder r=
	    // ewherequantifier[$scanningOrder.value]
	    {
		root_0 = (CommonTree) adaptor.nil();
		...
		r = ewherequantifier((scanningOrder32 != null ? scanningOrder32.value
			: null));
    ...
    // RuleInterpreterTree.g:85:1: swherequantifier[String order] returns [int
    // xpos] : ( FST (q= INCLD )? x= stokenspec | LST (p= INCLD )? y= stokenspec
    // | snum );
    public final RuleInterpreterTree.swherequantifier_return swherequantifier(
	...
	try {
	    // RuleInterpreterTree.g:86:2: ( FST (q= INCLD )? x= stokenspec |
	    // LST (p= INCLD )? y= stokenspec | snum )
	    int alt12 = 3;
	    switch (input.LA(1)) {
	    case FST: {
		alt12 = 1;
		...
		_last = (CommonTree) input.LT(1);
		FST33 = (CommonTree) match(input, FST,
			FOLLOW_FST_in_swherequantifier363);
		...
		// RuleInterpreterTree.g:86:9: q= INCLD
		{
		    ...
		    q = (CommonTree) match(input, INCLD,
			    FOLLOW_INCLD_in_swherequantifier367);
		...
		_last = (CommonTree) input.LT(1);
		LST34 = (CommonTree) match(input, LST,
			FOLLOW_LST_in_swherequantifier377);
		...
		// RuleInterpreterTree.g:86:99: p= INCLD
		{
		    ...
		    p = (CommonTree) match(input, INCLD,
			    FOLLOW_INCLD_in_swherequantifier381);
		...
		retval.xpos = this.ruler.evalPos((snum35 != null ? snum35.x
			: null), null, order);
    ...
    // RuleInterpreterTree.g:87:1: ewherequantifier[String order] returns [int
    // xpos] : ( FST (q= INCLD )? x= etokenspec | LST (p= INCLD )? y= etokenspec
    // | tnum );
    public final RuleInterpreterTree.ewherequantifier_return ewherequantifier(
	    String order) throws RecognitionException {
	...
	try {
	    // RuleInterpreterTree.g:88:2: ( FST (q= INCLD )? x= etokenspec |
	    // LST (p= INCLD )? y= etokenspec | tnum )
	    int alt15 = 3;
	    switch (input.LA(1)) {
	    case FST: {
		alt15 = 1;
		...
		_last = (CommonTree) input.LT(1);
		FST36 = (CommonTree) match(input, FST,
			FOLLOW_FST_in_ewherequantifier406);
		...
		// RuleInterpreterTree.g:88:9: q= INCLD
		{
		    _last = (CommonTree) input.LT(1);
		    q = (CommonTree) match(input, INCLD,
			    FOLLOW_INCLD_in_ewherequantifier410);
		    q_tree = (CommonTree) adaptor.dupNode(q);
		...
		_last = (CommonTree) input.LT(1);
		LST37 = (CommonTree) match(input, LST,
			FOLLOW_LST_in_ewherequantifier420);
		...
		// RuleInterpreterTree.g:88:99: p= INCLD
		{
		    _last = (CommonTree) input.LT(1);
		    p = (CommonTree) match(input, INCLD,
			    FOLLOW_INCLD_in_ewherequantifier424);
		    p_tree = (CommonTree) adaptor.dupNode(p);
		...
		retval.xpos = this.ruler.evalPos((tnum38 != null ? tnum38.x
			: null), null, order);
    ...
    public final RuleInterpreterTree.snum_return snum()
	    throws RecognitionException {
    ...
    public final RuleInterpreterTree.tnum_return tnum()
	    throws RecognitionException {
    ...
    public final RuleInterpreterTree.qnum_return qnum()
	    throws RecognitionException {
    ...
    public static final BitSet FOLLOW_quantifier_in_what89 = new BitSet(
	    new long[] { 0x0000000003E009A0L });
    public static final BitSet FOLLOW_tokenspec_in_what91 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_ANYTOKS_in_what94 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_ANYNUM_in_quantifier107 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_qnum_in_quantifier111 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_tokenspec131 = new BitSet(
	    new long[] { 0x0000000003E009A2L });
    public static final BitSet FOLLOW_singletokenspec_in_tokenspec135 = new BitSet(
	    new long[] { 0x0000000003E009A2L });
    public static final BitSet FOLLOW_singletokenspec_in_stokenspec157 = new BitSet(
	    new long[] { 0x0000000003E009A2L });
    public static final BitSet FOLLOW_singletokenspec_in_stokenspec161 = new BitSet(
	    new long[] { 0x0000000003E009A2L });
    public static final BitSet FOLLOW_singletokenspec_in_etokenspec183 = new BitSet(
	    new long[] { 0x0000000003E009A2L });
    public static final BitSet FOLLOW_singletokenspec_in_etokenspec187 = new BitSet(
	    new long[] { 0x0000000003E009A2L });
    public static final BitSet FOLLOW_token_in_singletokenspec202 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_type_in_singletokenspec205 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_DEL_in_operator218 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_ANYTYP_in_type232 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUMTYP_in_type236 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_WRDTYP_in_type240 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_SYBTYP_in_type244 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_BNKTYP_in_type248 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_SRTTYP_in_type252 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_ENDTYP_in_type256 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_ANYTOK_in_token268 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_TOKEN_in_token273 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_start_in_where288 = new BitSet(
	    new long[] { 0x0000000000003000L });
    public static final BitSet FOLLOW_end_in_where290 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_FRMB_in_scanningOrder304 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_FRME_in_scanningOrder308 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_scanningOrder_in_start322 = new BitSet(
	    new long[] { 0x0000000000124000L });
    public static final BitSet FOLLOW_swherequantifier_in_start326 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_scanningOrder_in_end340 = new BitSet(
	    new long[] { 0x0000000000124000L });
    public static final BitSet FOLLOW_ewherequantifier_in_end344 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_FST_in_swherequantifier363 = new BitSet(
	    new long[] { 0x0000000003E089A0L });
    public static final BitSet FOLLOW_INCLD_in_swherequantifier367 = new BitSet(
	    new long[] { 0x0000000003E009A0L });
    public static final BitSet FOLLOW_stokenspec_in_swherequantifier372 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_LST_in_swherequantifier377 = new BitSet(
	    new long[] { 0x0000000003E089A0L });
    public static final BitSet FOLLOW_INCLD_in_swherequantifier381 = new BitSet(
	    new long[] { 0x0000000003E009A0L });
    public static final BitSet FOLLOW_stokenspec_in_swherequantifier386 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_snum_in_swherequantifier390 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_FST_in_ewherequantifier406 = new BitSet(
	    new long[] { 0x0000000003E089A0L });
    public static final BitSet FOLLOW_INCLD_in_ewherequantifier410 = new BitSet(
	    new long[] { 0x0000000003E009A0L });
    public static final BitSet FOLLOW_etokenspec_in_ewherequantifier415 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_LST_in_ewherequantifier420 = new BitSet(
	    new long[] { 0x0000000003E089A0L });
    public static final BitSet FOLLOW_INCLD_in_ewherequantifier424 = new BitSet(
	    new long[] { 0x0000000003E009A0L });
    public static final BitSet FOLLOW_etokenspec_in_ewherequantifier429 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_tnum_in_ewherequantifier433 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUM_in_snum445 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUM_in_tnum456 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUM_in_qnum467 = new BitSet(
	    new long[] { 0x0000000000000002L });
