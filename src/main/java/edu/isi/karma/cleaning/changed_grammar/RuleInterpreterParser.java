...
public class RuleInterpreterParser extends Parser {
	...
	return RuleInterpreterParser.tokenNames;
    }

    public String getGrammarFileName() {
	return "RuleInterpreter.g";
    }
    ...
    public final RuleInterpreterParser.rule_return rule()
    ...
    public final RuleInterpreterParser.what_return what()
	    throws RecognitionException {
    ...
    public final RuleInterpreterParser.quantifier_return quantifier()
	    throws RecognitionException {
    ...
    // RuleInterpreter.g:48:1: tokenspec : ( singletokenspec | singletokenspec
    // tokenspec );
    public final RuleInterpreterParser.tokenspec_return tokenspec()
	    throws RecognitionException {
	...
	try {
	    // RuleInterpreter.g:48:12: ( singletokenspec | singletokenspec
	    // tokenspec )
	    int alt2 = 2;
		...
		if (((LA2_1 >= FRMB && LA2_1 <= FRME))) {
		    alt2 = 1;
		} else if ((LA2_1 == ANYTOK
			|| (LA2_1 >= ANYTYP && LA2_1 <= BNKTYP)
			|| LA2_1 == ENDTYP || (LA2_1 >= NUMTYP && LA2_1 <= WRDTYP))) {
		    alt2 = 2;
		} else {
	    ...
	    } else if (((LA2_0 >= ANYTYP && LA2_0 <= BNKTYP) || LA2_0 == ENDTYP
		    || (LA2_0 >= NUMTYP && LA2_0 <= SYBTYP) || LA2_0 == WRDTYP)) {
		int LA2_2 = input.LA(2);

		if (((LA2_2 >= FRMB && LA2_2 <= FRME))) {
		    alt2 = 1;
		} else if ((LA2_2 == ANYTOK
			|| (LA2_2 >= ANYTYP && LA2_2 <= BNKTYP)
			|| LA2_2 == ENDTYP || (LA2_2 >= NUMTYP && LA2_2 <= WRDTYP))) {
		    alt2 = 2;
		} else {
		    NoViableAltException nvae = new NoViableAltException("", 2,
			    2, input);
    ...
    // RuleInterpreter.g:49:1: stokenspec : ( singletokenspec | singletokenspec
    // stokenspec );
    public final RuleInterpreterParser.stokenspec_return stokenspec()
	    throws RecognitionException {
	...
	try {
	    // RuleInterpreter.g:49:12: ( singletokenspec | singletokenspec
	    // stokenspec )
	    int alt3 = 2;
		...
		if (((LA3_1 >= FRMB && LA3_1 <= FRME))) {
		    alt3 = 1;
		} else if ((LA3_1 == ANYTOK
			|| (LA3_1 >= ANYTYP && LA3_1 <= BNKTYP)
			|| LA3_1 == ENDTYP || (LA3_1 >= NUMTYP && LA3_1 <= WRDTYP))) {
		    alt3 = 2;
		} else {
	    ...
	    } else if (((LA3_0 >= ANYTYP && LA3_0 <= BNKTYP) || LA3_0 == ENDTYP
		    || (LA3_0 >= NUMTYP && LA3_0 <= SYBTYP) || LA3_0 == WRDTYP)) {
		int LA3_2 = input.LA(2);

		if (((LA3_2 >= FRMB && LA3_2 <= FRME))) {
		    alt3 = 1;
		} else if ((LA3_2 == ANYTOK
			|| (LA3_2 >= ANYTYP && LA3_2 <= BNKTYP)
			|| LA3_2 == ENDTYP || (LA3_2 >= NUMTYP && LA3_2 <= WRDTYP))) {
		    alt3 = 2;
		} else {
		    NoViableAltException nvae = new NoViableAltException("", 3,
			    2, input);
    ...
    // RuleInterpreter.g:50:1: etokenspec : ( singletokenspec | singletokenspec
    // etokenspec );
    public final RuleInterpreterParser.etokenspec_return etokenspec()
	    throws RecognitionException {
	...
	try {
	    // RuleInterpreter.g:50:13: ( singletokenspec | singletokenspec
	    // etokenspec )
	    int alt4 = 2;
		...
		if ((LA4_1 == EOF)) {
		    alt4 = 1;
		} else if ((LA4_1 == ANYTOK
			|| (LA4_1 >= ANYTYP && LA4_1 <= BNKTYP)
			|| LA4_1 == ENDTYP || (LA4_1 >= NUMTYP && LA4_1 <= WRDTYP))) {
		    alt4 = 2;
		} else {
	    ...
	    } else if (((LA4_0 >= ANYTYP && LA4_0 <= BNKTYP) || LA4_0 == ENDTYP
		    || (LA4_0 >= NUMTYP && LA4_0 <= SYBTYP) || LA4_0 == WRDTYP)) {
		int LA4_2 = input.LA(2);

		if ((LA4_2 == EOF)) {
		    alt4 = 1;
		} else if ((LA4_2 == ANYTOK
			|| (LA4_2 >= ANYTYP && LA4_2 <= BNKTYP)
			|| LA4_2 == ENDTYP || (LA4_2 >= NUMTYP && LA4_2 <= WRDTYP))) {
		    alt4 = 2;
		} else {
		    NoViableAltException nvae = new NoViableAltException("", 4,
			    2, input);
    ...
    public final RuleInterpreterParser.singletokenspec_return singletokenspec()
	    throws RecognitionException {
	...
	try {
		...
		alt5 = 1;
	    } else if (((LA5_0 >= ANYTYP && LA5_0 <= BNKTYP) || LA5_0 == ENDTYP
    ...
    public final RuleInterpreterParser.operator_return operator()
	    throws RecognitionException {
	...
	try {
		...
		DEL19_tree = (Object) adaptor.create(DEL19);
    ...
    // $ANTLR start "type"
    // RuleInterpreter.g:57:1: type : ( ANYTYP | NUMTYP | WRDTYP | SYBTYP |
    // BNKTYP | SRTTYP | ENDTYP );
    public final RuleInterpreterParser.type_return type()
	    throws RecognitionException {
	...
	try {
	    // RuleInterpreter.g:57:6: ( ANYTYP | NUMTYP | WRDTYP | SYBTYP |
	    // BNKTYP | SRTTYP | ENDTYP )
	    // RuleInterpreter.g:
	    {
		root_0 = (Object) adaptor.nil();
		...
		if ((input.LA(1) >= ANYTYP && input.LA(1) <= BNKTYP)
			|| input.LA(1) == ENDTYP
    ...
    public final RuleInterpreterParser.token_return token()
	    throws RecognitionException {
    ...
    public final RuleInterpreterParser.where_return where()
	    throws RecognitionException {
    ...
    public final RuleInterpreterParser.scanningOrder_return scanningOrder()
	    throws RecognitionException {
    ...
    public final RuleInterpreterParser.start_return start()
	    throws RecognitionException {
    ...
    public final RuleInterpreterParser.end_return end()
	    throws RecognitionException {
    ...
    // RuleInterpreter.g:70:1: swherequantifier : ( FST ( INCLD )? stokenspec |
    // snum );
    public final RuleInterpreterParser.swherequantifier_return swherequantifier()
	    throws RecognitionException {
	...
	try {
		...
		FST29 = (Token) match(input, FST,
			FOLLOW_FST_in_swherequantifier380);
		FST29_tree = (Object) adaptor.create(FST29);
		...
		// RuleInterpreter.g:70:24: INCLD
		{
		    INCLD30 = (Token) match(input, INCLD,
			    FOLLOW_INCLD_in_swherequantifier382);
		    INCLD30_tree = (Object) adaptor.create(INCLD30);
    ...
    // RuleInterpreter.g:71:1: ewherequantifier : ( FST ( INCLD )? etokenspec |
    // tnum );
    public final RuleInterpreterParser.ewherequantifier_return ewherequantifier()
	    throws RecognitionException {
	...
	try {
		...
		FST33 = (Token) match(input, FST,
			FOLLOW_FST_in_ewherequantifier395);
		...
		// RuleInterpreter.g:71:24: INCLD
		{
		    INCLD34 = (Token) match(input, INCLD,
			    FOLLOW_INCLD_in_ewherequantifier397);
    ...
    public final RuleInterpreterParser.snum_return snum()
	    throws RecognitionException {
	...
	try {
		...
		NUM37_tree = (Object) adaptor.create(NUM37);
    ...
    public final RuleInterpreterParser.tnum_return tnum()
	    throws RecognitionException {
    ...
    public static final BitSet FOLLOW_operator_in_rule209 = new BitSet(
	    new long[] { 0x0000000000100050L });
    public static final BitSet FOLLOW_what_in_rule211 = new BitSet(
	    new long[] { 0x0000000000003000L });
    public static final BitSet FOLLOW_where_in_rule213 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_quantifier_in_what220 = new BitSet(
	    new long[] { 0x0000000003E009A0L });
    public static final BitSet FOLLOW_tokenspec_in_what222 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_ANYTOKS_in_what224 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_tokenspec243 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_tokenspec247 = new BitSet(
	    new long[] { 0x0000000003E009A0L });
    public static final BitSet FOLLOW_tokenspec_in_tokenspec249 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_stokenspec256 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_stokenspec260 = new BitSet(
	    new long[] { 0x0000000003E009A0L });
    public static final BitSet FOLLOW_stokenspec_in_stokenspec262 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_etokenspec270 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_etokenspec274 = new BitSet(
	    new long[] { 0x0000000003E009A0L });
    public static final BitSet FOLLOW_etokenspec_in_etokenspec276 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_token_in_singletokenspec283 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_type_in_singletokenspec285 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_DEL_in_operator292 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_start_in_where337 = new BitSet(
	    new long[] { 0x0000000000003000L });
    public static final BitSet FOLLOW_end_in_where339 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_scanningOrder_in_start360 = new BitSet(
	    new long[] { 0x0000000000104000L });
    public static final BitSet FOLLOW_swherequantifier_in_start362 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_scanningOrder_in_end369 = new BitSet(
	    new long[] { 0x0000000000104000L });
    public static final BitSet FOLLOW_ewherequantifier_in_end371 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_FST_in_swherequantifier380 = new BitSet(
	    new long[] { 0x0000000003E089A0L });
    public static final BitSet FOLLOW_INCLD_in_swherequantifier382 = new BitSet(
	    new long[] { 0x0000000003E009A0L });
    public static final BitSet FOLLOW_stokenspec_in_swherequantifier385 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_snum_in_swherequantifier388 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_FST_in_ewherequantifier395 = new BitSet(
	    new long[] { 0x0000000003E089A0L });
    public static final BitSet FOLLOW_INCLD_in_ewherequantifier397 = new BitSet(
	    new long[] { 0x0000000003E009A0L });
    public static final BitSet FOLLOW_etokenspec_in_ewherequantifier400 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_tnum_in_ewherequantifier403 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUM_in_snum410 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUM_in_tnum417 = new BitSet(
	    new long[] { 0x0000000000000002L });
