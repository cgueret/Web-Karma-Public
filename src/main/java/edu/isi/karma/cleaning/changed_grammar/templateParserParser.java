...
public class templateParserParser extends Parser {
    public static final String[] tokenNames = new String[] { "<invalid>",
	    "<EOR>", "<DOWN>", "<UP>", "ANYNUM", "ANYTOK", "BNKTYP", "DIGIT",
	    "ENDTYP", "FRMB", "FRME", "FST", "INCLD", "LST", "NEWLINE", "NUM",
	...
	return templateParserParser.tokenNames;
    }

    public String getGrammarFileName() {
	return "templateParser.g";
    }
    ...
    public final templateParserParser.qnum_return qnum()
	...
	try {
		...
		GrammarTreeNode gtn = new GrammarTreeNode(
			(NUM1 != null ? NUM1.getText() : null));
		retval.tok.addChild(gtn);
    ...
    public final templateParserParser.snum_return snum()
	    throws RecognitionException {
    ...
    public final templateParserParser.tnum_return tnum()
	    throws RecognitionException {
    ...
    public final templateParserParser.dnum_return dnum()
	    throws RecognitionException {
	...
	try {
		...
		NUM4_tree = (Object) adaptor.create(NUM4);
		adaptor.addChild(root_0, NUM4_tree);

		GrammarTreeNode gtn = new GrammarTreeNode(
			(NUM4 != null ? NUM4.getText() : null));
		retval.tok.addChild(gtn);
    ...
    // templateParser.g:48:1: tokenspec returns [GrammarTreeNode tok] : t=
    // singletokenspec (s= singletokenspec )* ;
    public final templateParserParser.tokenspec_return tokenspec()
	    throws RecognitionException {
    ...
    // templateParser.g:52:1: stokenspec returns [GrammarTreeNode tok] : (
    // ANYTOK |t= singletokenspec (s= singletokenspec )* );
    public final templateParserParser.stokenspec_return stokenspec()
	    throws RecognitionException {
	...
	try {
	    // templateParser.g:54:3: ( ANYTOK |t= singletokenspec (s=
	    // singletokenspec )* )
	    int alt3 = 2;
		...
		ANYTOK5 = (Token) match(input, ANYTOK,
			FOLLOW_ANYTOK_in_stokenspec272);
		ANYTOK5_tree = (Object) adaptor.create(ANYTOK5);
		adaptor.addChild(root_0, ANYTOK5_tree);

		GrammarTreeNode gtn = new GrammarTreeNode(
			(ANYTOK5 != null ? ANYTOK5.getText() : null));
		retval.tok.addChild(gtn);
    ...
    // templateParser.g:55:1: etokenspec returns [GrammarTreeNode tok] : (
    // ANYTOK |t= singletokenspec (s= singletokenspec )* );
    public final templateParserParser.etokenspec_return etokenspec()
	    throws RecognitionException {
	...
	try {
	    // templateParser.g:57:3: ( ANYTOK |t= singletokenspec (s=
	    // singletokenspec )* )
	    int alt5 = 2;
		...
		ANYTOK6 = (Token) match(input, ANYTOK,
			FOLLOW_ANYTOK_in_etokenspec305);
		ANYTOK6_tree = (Object) adaptor.create(ANYTOK6);
		adaptor.addChild(root_0, ANYTOK6_tree);

		GrammarTreeNode gtn = new GrammarTreeNode(
			(ANYTOK6 != null ? ANYTOK6.getText() : null));
		retval.tok.addChild(gtn);
    ...
    // templateParser.g:58:1: dtokenspec returns [GrammarTreeNode tok] : (
    // ANYTOK |t= singletokenspec (s= singletokenspec )* );
    public final templateParserParser.dtokenspec_return dtokenspec()
	    throws RecognitionException {
	...
	try {
	    // templateParser.g:60:3: ( ANYTOK |t= singletokenspec (s=
	    // singletokenspec )* )
	    int alt7 = 2;
		...
		ANYTOK7 = (Token) match(input, ANYTOK,
			FOLLOW_ANYTOK_in_dtokenspec338);
		ANYTOK7_tree = (Object) adaptor.create(ANYTOK7);
		adaptor.addChild(root_0, ANYTOK7_tree);

		GrammarTreeNode gtn = new GrammarTreeNode(
			(ANYTOK7 != null ? ANYTOK7.getText() : null));
		retval.tok.addChild(gtn);
    ...
    // templateParser.g:62:1: singletokenspec returns [GrammarTreeNode tok] : (
    // token | type );
    public final templateParserParser.singletokenspec_return singletokenspec()
	    throws RecognitionException {
	...
	try {
	    ...
	    if ((LA8_0 == TOKEN)) {
		alt8 = 1;
	    } else if ((LA8_0 == BNKTYP || LA8_0 == ENDTYP
		    || (LA8_0 >= NUMTYP && LA8_0 <= SYBTYP) || LA8_0 == WRDTYP)) {
		alt8 = 2;
	    } else {
    ...
    public final templateParserParser.token_return token()
	    throws RecognitionException {
	...
	try {
		...
		TOKEN10_tree = (Object) adaptor.create(TOKEN10);
		adaptor.addChild(root_0, TOKEN10_tree);

		GrammarTreeNode gtn = new GrammarTreeNode(
			(TOKEN10 != null ? TOKEN10.getText() : null));
		retval.tok.addChild(gtn);
    ...
    // $ANTLR start "type"
    // templateParser.g:70:1: type returns [GrammarTreeNode tok] : ( NUMTYP |
    // WRDTYP | SYBTYP | BNKTYP | SRTTYP | ENDTYP );
    public final templateParserParser.type_return type()
	    throws RecognitionException {
	...
	try {
		...
		NUMTYP11 = (Token) match(input, NUMTYP,
			FOLLOW_NUMTYP_in_type414);
		NUMTYP11_tree = (Object) adaptor.create(NUMTYP11);
		adaptor.addChild(root_0, NUMTYP11_tree);

		GrammarTreeNode gtn = new GrammarTreeNode(
			(NUMTYP11 != null ? NUMTYP11.getText() : null));
		retval.tok.addChild(gtn);
		...
		WRDTYP12 = (Token) match(input, WRDTYP,
			FOLLOW_WRDTYP_in_type418);
		WRDTYP12_tree = (Object) adaptor.create(WRDTYP12);
		adaptor.addChild(root_0, WRDTYP12_tree);

		GrammarTreeNode gtn = new GrammarTreeNode(
			(WRDTYP12 != null ? WRDTYP12.getText() : null));
		retval.tok.addChild(gtn);
		...
		SYBTYP13 = (Token) match(input, SYBTYP,
			FOLLOW_SYBTYP_in_type422);
		SYBTYP13_tree = (Object) adaptor.create(SYBTYP13);
		adaptor.addChild(root_0, SYBTYP13_tree);

		GrammarTreeNode gtn = new GrammarTreeNode(
			(SYBTYP13 != null ? SYBTYP13.getText() : null));
		retval.tok.addChild(gtn);
		...
		BNKTYP14 = (Token) match(input, BNKTYP,
			FOLLOW_BNKTYP_in_type426);
		BNKTYP14_tree = (Object) adaptor.create(BNKTYP14);
		adaptor.addChild(root_0, BNKTYP14_tree);

		GrammarTreeNode gtn = new GrammarTreeNode(
			(BNKTYP14 != null ? BNKTYP14.getText() : null));
		retval.tok.addChild(gtn);
		...
		SRTTYP15 = (Token) match(input, SRTTYP,
			FOLLOW_SRTTYP_in_type430);
		SRTTYP15_tree = (Object) adaptor.create(SRTTYP15);
		adaptor.addChild(root_0, SRTTYP15_tree);

		GrammarTreeNode gtn = new GrammarTreeNode(
			(SRTTYP15 != null ? SRTTYP15.getText() : null));
		retval.tok.addChild(gtn);
		...
		ENDTYP16 = (Token) match(input, ENDTYP,
			FOLLOW_ENDTYP_in_type434);
		ENDTYP16_tree = (Object) adaptor.create(ENDTYP16);
		adaptor.addChild(root_0, ENDTYP16_tree);

		GrammarTreeNode gtn = new GrammarTreeNode(
			(ENDTYP16 != null ? ENDTYP16.getText() : null));
		retval.tok.addChild(gtn);
    ...
    public static final BitSet FOLLOW_NUM_in_qnum168 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUM_in_snum187 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUM_in_tnum205 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUM_in_dnum223 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_tokenspec244 = new BitSet(
	    new long[] { 0x00000000001F0142L });
    public static final BitSet FOLLOW_singletokenspec_in_tokenspec250 = new BitSet(
	    new long[] { 0x00000000001F0142L });
    public static final BitSet FOLLOW_ANYTOK_in_stokenspec272 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_stokenspec278 = new BitSet(
	    new long[] { 0x00000000001F0142L });
    public static final BitSet FOLLOW_singletokenspec_in_stokenspec284 = new BitSet(
	    new long[] { 0x00000000001F0142L });
    public static final BitSet FOLLOW_ANYTOK_in_etokenspec305 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_etokenspec311 = new BitSet(
	    new long[] { 0x00000000001F0142L });
    public static final BitSet FOLLOW_singletokenspec_in_etokenspec317 = new BitSet(
	    new long[] { 0x00000000001F0142L });
    public static final BitSet FOLLOW_ANYTOK_in_dtokenspec338 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_dtokenspec344 = new BitSet(
	    new long[] { 0x00000000001F0142L });
    public static final BitSet FOLLOW_singletokenspec_in_dtokenspec350 = new BitSet(
	    new long[] { 0x00000000001F0142L });
    public static final BitSet FOLLOW_token_in_singletokenspec372 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_type_in_singletokenspec375 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_TOKEN_in_token394 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUMTYP_in_type414 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_WRDTYP_in_type418 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_SYBTYP_in_type422 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_BNKTYP_in_type426 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_SRTTYP_in_type430 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_ENDTYP_in_type434 = new BitSet(
	    new long[] { 0x0000000000000002L });
