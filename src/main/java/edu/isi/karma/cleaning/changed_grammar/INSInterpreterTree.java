...
public class INSInterpreterTree extends TreeParser {
    public static final String[] tokenNames = new String[] { "<invalid>",
	    "<EOR>", "<DOWN>", "<UP>", "ANYNUM", "ANYTOK", "ANYTYP", "BNKTYP",
	    "DIGIT", "ENDTYP", "FRMB", "FRME", "FST", "INCLD", "INS", "LST",
	    "NEWLINE", "NUM", "NUMTYP", "SRTTYP", "SYBTYP", "TOKEN", "WRDTYP",
	    "WS" };
	...
	return INSInterpreterTree.tokenNames;
    }

    public String getGrammarFileName() {
	return "INSInterpreterTree.g";
    }
    ...
    public final INSInterpreterTree.rule_return rule()
	...
	try {
		...
		this.ruler.doOperation((operator1 != null ? operator1.value
			: null), "-1", (what2 != null ? what2.res : null),
			(dest3 != null ? dest3.pos : 0), -1);
    ...
    public final INSInterpreterTree.what_return what()
	    throws RecognitionException {
    ...
    // INSInterpreterTree.g:50:1: tokenspec returns [Vector<TNode> res] :
    // singletokenspec[toks] ( singletokenspec[toks] )* ;
    public final INSInterpreterTree.tokenspec_return tokenspec()
	    throws RecognitionException {
	...
	try {
	    // INSInterpreterTree.g:52:2: ( singletokenspec[toks] (
	    // singletokenspec[toks] )* )
	    // INSInterpreterTree.g:52:4: singletokenspec[toks] (
	    // singletokenspec[toks] )*
	    {
		root_0 = (CommonTree) adaptor.nil();
    ...
    // INSInterpreterTree.g:53:1: dtokenspec returns [Vector<TNode> res] :
    // singletokenspec[toks] ( singletokenspec[toks] )* ;
    public final INSInterpreterTree.dtokenspec_return dtokenspec()
	    throws RecognitionException {
	...
	Vector<TNode> toks = new Vector<TNode>();
	try {
	    // INSInterpreterTree.g:55:2: ( singletokenspec[toks] (
	    // singletokenspec[toks] )* )
	    // INSInterpreterTree.g:55:4: singletokenspec[toks] (
	    // singletokenspec[toks] )*
	    {
		root_0 = (CommonTree) adaptor.nil();
    ...
    // INSInterpreterTree.g:56:1: singletokenspec[Vector<TNode> tokspec] : (
    // token | type );
    public final INSInterpreterTree.singletokenspec_return singletokenspec(
	...
	try {
		...
		tokspec.add(new TNode("ANYTYP", (token9 != null ? token9.value
			: null).substring(1, (token9 != null ? token9.value
			: null).length() - 1)));
		...
		tokspec.add(new TNode((type10 != null ? type10.value : null),
			"ANYTOK"));
    ...
    public final INSInterpreterTree.operator_return operator()
	    throws RecognitionException {
	...
	try {
		...
		_last = (CommonTree) input.LT(1);
		INS11 = (CommonTree) match(input, INS,
			FOLLOW_INS_in_operator167);
    ...
    // $ANTLR start "type"
    // INSInterpreterTree.g:61:1: type returns [String value] : ( NUMTYP |
    // WRDTYP | SYBTYP | BNKTYP | SRTTYP | ENDTYP );
    public final INSInterpreterTree.type_return type()
	    throws RecognitionException {
	...
	try {
		...
		_last = (CommonTree) input.LT(1);
		NUMTYP12 = (CommonTree) match(input, NUMTYP,
			FOLLOW_NUMTYP_in_type180);
		...
		_last = (CommonTree) input.LT(1);
		WRDTYP13 = (CommonTree) match(input, WRDTYP,
			FOLLOW_WRDTYP_in_type184);
		...
		_last = (CommonTree) input.LT(1);
		SYBTYP14 = (CommonTree) match(input, SYBTYP,
			FOLLOW_SYBTYP_in_type188);
		...
		_last = (CommonTree) input.LT(1);
		BNKTYP15 = (CommonTree) match(input, BNKTYP,
			FOLLOW_BNKTYP_in_type192);
		...
		_last = (CommonTree) input.LT(1);
		SRTTYP16 = (CommonTree) match(input, SRTTYP,
			FOLLOW_SRTTYP_in_type196);
		...
		_last = (CommonTree) input.LT(1);
		ENDTYP17 = (CommonTree) match(input, ENDTYP,
			FOLLOW_ENDTYP_in_type200);
    ...
    public final INSInterpreterTree.token_return token()
	    throws RecognitionException {
	...
	try {
		...
		_last = (CommonTree) input.LT(1);
		TOKEN18 = (CommonTree) match(input, TOKEN,
			FOLLOW_TOKEN_in_token212);
    ...
    // INSInterpreterTree.g:66:1: scanningOrder returns [String value] : ( FRMB
    // | FRME );
    public final INSInterpreterTree.scanningOrder_return scanningOrder()
	    throws RecognitionException {
	...
	try {
		...
		_last = (CommonTree) input.LT(1);
		FRMB19 = (CommonTree) match(input, FRMB,
			FOLLOW_FRMB_in_scanningOrder229);
		...
		_last = (CommonTree) input.LT(1);
		FRME20 = (CommonTree) match(input, FRME,
			FOLLOW_FRME_in_scanningOrder233);
    ...
    // $ANTLR start "dest"
    // INSInterpreterTree.g:69:1: dest returns [int pos] : scanningOrder r=
    // dwherequantifier[$scanningOrder.value] ;
    public final INSInterpreterTree.dest_return dest()
	    throws RecognitionException {
	...
	try {
	    // INSInterpreterTree.g:69:23: ( scanningOrder r=
	    // dwherequantifier[$scanningOrder.value] )
	    // INSInterpreterTree.g:69:26: scanningOrder r=
	    // dwherequantifier[$scanningOrder.value]
	    {
		root_0 = (CommonTree) adaptor.nil();
		...
		r = dwherequantifier((scanningOrder21 != null ? scanningOrder21.value
			: null));
    ...
    // INSInterpreterTree.g:72:1: dwherequantifier[String order] returns [int
    // pos] : ( FST (q= INCLD )? x= dtokenspec | LST (p= INCLD )? y= dtokenspec
    // | dnum );
    public final INSInterpreterTree.dwherequantifier_return dwherequantifier(
	...
	try {
	    // INSInterpreterTree.g:73:2: ( FST (q= INCLD )? x= dtokenspec | LST
		...
		_last = (CommonTree) input.LT(1);
		FST22 = (CommonTree) match(input, FST,
			FOLLOW_FST_in_dwherequantifier270);
		...
		// INSInterpreterTree.g:73:9: q= INCLD
		{
		    ...
		    q = (CommonTree) match(input, INCLD,
			    FOLLOW_INCLD_in_dwherequantifier274);
		...
		retval.pos = this.ruler.evalPos(
			(FST22 != null ? FST22.getText() : null)
		...
		_last = (CommonTree) input.LT(1);
		LST23 = (CommonTree) match(input, LST,
			FOLLOW_LST_in_dwherequantifier284);
		...
		// INSInterpreterTree.g:73:98: p= INCLD
		{
		    ...
		    p = (CommonTree) match(input, INCLD,
			    FOLLOW_INCLD_in_dwherequantifier288);
		...
		retval.pos = this.ruler.evalPos((dnum24 != null ? dnum24.x
			: null), null, order);
    ...
    public final INSInterpreterTree.dnum_return dnum()
	    throws RecognitionException {
    ...
    public static final BitSet FOLLOW_operator_in_rule71 = new BitSet(
	    new long[] { 0x00000000007C0280L });
    public static final BitSet FOLLOW_what_in_rule73 = new BitSet(
	    new long[] { 0x0000000000000C00L });
    public static final BitSet FOLLOW_dest_in_rule75 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_tokenspec_in_what88 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_tokenspec107 = new BitSet(
	    new long[] { 0x00000000007C0282L });
    public static final BitSet FOLLOW_singletokenspec_in_tokenspec111 = new BitSet(
	    new long[] { 0x00000000007C0282L });
    public static final BitSet FOLLOW_singletokenspec_in_dtokenspec133 = new BitSet(
	    new long[] { 0x00000000007C0282L });
    public static final BitSet FOLLOW_singletokenspec_in_dtokenspec137 = new BitSet(
	    new long[] { 0x00000000007C0282L });
    public static final BitSet FOLLOW_token_in_singletokenspec151 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_type_in_singletokenspec154 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_INS_in_operator167 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUMTYP_in_type180 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_WRDTYP_in_type184 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_SYBTYP_in_type188 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_BNKTYP_in_type192 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_SRTTYP_in_type196 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_ENDTYP_in_type200 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_TOKEN_in_token212 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_FRMB_in_scanningOrder229 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_FRME_in_scanningOrder233 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_scanningOrder_in_dest247 = new BitSet(
	    new long[] { 0x0000000000029000L });
    public static final BitSet FOLLOW_dwherequantifier_in_dest251 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_FST_in_dwherequantifier270 = new BitSet(
	    new long[] { 0x00000000007C2280L });
    public static final BitSet FOLLOW_INCLD_in_dwherequantifier274 = new BitSet(
	    new long[] { 0x00000000007C0280L });
    public static final BitSet FOLLOW_dtokenspec_in_dwherequantifier279 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_LST_in_dwherequantifier284 = new BitSet(
	    new long[] { 0x00000000007C2280L });
    public static final BitSet FOLLOW_INCLD_in_dwherequantifier288 = new BitSet(
	    new long[] { 0x00000000007C0280L });
    public static final BitSet FOLLOW_dtokenspec_in_dwherequantifier293 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_dnum_in_dwherequantifier297 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUM_in_dnum310 = new BitSet(
	    new long[] { 0x0000000000000002L });
