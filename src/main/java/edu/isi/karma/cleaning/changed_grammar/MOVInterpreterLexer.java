...
public class MOVInterpreterLexer extends Lexer {
	...
	// MOVInterpreter.g:1:8: ( ANYTOKS | BNKTYP | ENDTYP | FRMB | FRME | FST
	// | INCLD | LST | MOV | NUMTYP | SRTTYP | SYBTYP | WRDTYP | TOKEN |
	// NEWLINE | WS | NUM )
	int alt5 = 17;
	switch (input.LA(1)) {
	case 'a': {
	...
	case 'f': {
		...
		NoViableAltException nvae = new NoViableAltException("", 5, 4,
			input);
