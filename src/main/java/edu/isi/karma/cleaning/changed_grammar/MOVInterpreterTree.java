...
public class MOVInterpreterTree extends TreeParser {
    public static final String[] tokenNames = new String[] { "<invalid>",
	    "<EOR>", "<DOWN>", "<UP>", "ANYTOKS", "BNKTYP", "DIGIT", "ENDTYP",
	    "FRMB", "FRME", "FST", "INCLD", "LST", "MOV", "NEWLINE", "NUM",
	    "NUMTYP", "SRTTYP", "SYBTYP", "TOKEN", "WRDTYP", "WS" };
	...
	return MOVInterpreterTree.tokenNames;
    }

    public String getGrammarFileName() {
	return "MOVInterpreterTree.g";
    }
    ...
    public final MOVInterpreterTree.rule_return rule()
	...
	try {
		...
		this.ruler.doOperation((operator1 != null ? operator1.value
			: null), String
			.valueOf((dest4 != null ? dest4.pos : 0)),
			(what2 != null ? what2.res : null),
			(where3 != null ? where3.spos : 0),
			(where3 != null ? where3.epos : 0));
    ...
    // $ANTLR start "what"
    // MOVInterpreterTree.g:49:1: what returns [Vector<TNode> res] : ( tokenspec
    // | ANYTOKS );
    public final MOVInterpreterTree.what_return what()
	    throws RecognitionException {
	...
	try {
		...
		_last = (CommonTree) input.LT(1);
		ANYTOKS6 = (CommonTree) match(input, ANYTOKS,
			FOLLOW_ANYTOKS_in_what93);
    ...
    // MOVInterpreterTree.g:52:1: tokenspec returns [Vector<TNode> res] :
    // singletokenspec[toks] ( singletokenspec[toks] )* ;
    public final MOVInterpreterTree.tokenspec_return tokenspec()
	    throws RecognitionException {
	...
	try {
	    // MOVInterpreterTree.g:54:2: ( singletokenspec[toks] (
	    // singletokenspec[toks] )* )
	    // MOVInterpreterTree.g:54:4: singletokenspec[toks] (
	    // singletokenspec[toks] )*
	    {
		root_0 = (CommonTree) adaptor.nil();
    ...
    // MOVInterpreterTree.g:55:1: stokenspec returns [Vector<TNode> res] :
    // singletokenspec[toks] ( singletokenspec[toks] )* ;
    public final MOVInterpreterTree.stokenspec_return stokenspec()
	    throws RecognitionException {
	...
	Vector<TNode> toks = new Vector<TNode>();
	try {
	    // MOVInterpreterTree.g:57:2: ( singletokenspec[toks] (
	    // singletokenspec[toks] )* )
	    // MOVInterpreterTree.g:57:4: singletokenspec[toks] (
	    // singletokenspec[toks] )*
	    {
		root_0 = (CommonTree) adaptor.nil();
    ...
    // MOVInterpreterTree.g:58:1: etokenspec returns [Vector<TNode> res] :
    // singletokenspec[toks] ( singletokenspec[toks] )* ;
    public final MOVInterpreterTree.etokenspec_return etokenspec()
	    throws RecognitionException {
	...
	Vector<TNode> toks = new Vector<TNode>();
	try {
	    // MOVInterpreterTree.g:60:2: ( singletokenspec[toks] (
	    // singletokenspec[toks] )* )
	    // MOVInterpreterTree.g:60:4: singletokenspec[toks] (
	    // singletokenspec[toks] )*
	    {
		root_0 = (CommonTree) adaptor.nil();
    ...
    // MOVInterpreterTree.g:61:1: dtokenspec returns [Vector<TNode> res] :
    // singletokenspec[toks] ( singletokenspec[toks] )* ;
    public final MOVInterpreterTree.dtokenspec_return dtokenspec()
	    throws RecognitionException {
	...
	Vector<TNode> toks = new Vector<TNode>();
	try {
	    // MOVInterpreterTree.g:63:2: ( singletokenspec[toks] (
	    // singletokenspec[toks] )* )
	    // MOVInterpreterTree.g:63:4: singletokenspec[toks] (
	    // singletokenspec[toks] )*
	    {
		root_0 = (CommonTree) adaptor.nil();
    ...
    // MOVInterpreterTree.g:65:1: singletokenspec[Vector<TNode> tokspec] : (
    // token | type );
    public final MOVInterpreterTree.singletokenspec_return singletokenspec(
	    Vector<TNode> tokspec) throws RecognitionException {
	...
	try {
	    ...
	    if ((LA6_0 == TOKEN)) {
		alt6 = 1;
	    } else if ((LA6_0 == BNKTYP || LA6_0 == ENDTYP
		    || (LA6_0 >= NUMTYP && LA6_0 <= SYBTYP) || LA6_0 == WRDTYP)) {
		alt6 = 2;
	    } else {
		...
		tokspec.add(new TNode("ANYTYP",
			(token15 != null ? token15.value : null).substring(1,
				(token15 != null ? token15.value : null)
					.length() - 1)));
		...
		tokspec.add(new TNode((type16 != null ? type16.value : null),
			"ANYTOK"));
    ...
    public final MOVInterpreterTree.operator_return operator()
	    throws RecognitionException {
	...
	try {
		...
		_last = (CommonTree) input.LT(1);
		MOV17 = (CommonTree) match(input, MOV,
			FOLLOW_MOV_in_operator226);
    ...
    // $ANTLR start "type"
    // MOVInterpreterTree.g:71:1: type returns [String value] : ( NUMTYP |
    // WRDTYP | SYBTYP | BNKTYP | SRTTYP | ENDTYP );
    public final MOVInterpreterTree.type_return type()
	    throws RecognitionException {
	...
	try {
		...
		_last = (CommonTree) input.LT(1);
		NUMTYP18 = (CommonTree) match(input, NUMTYP,
			FOLLOW_NUMTYP_in_type240);
		...
		_last = (CommonTree) input.LT(1);
		WRDTYP19 = (CommonTree) match(input, WRDTYP,
			FOLLOW_WRDTYP_in_type244);
		...
		_last = (CommonTree) input.LT(1);
		SYBTYP20 = (CommonTree) match(input, SYBTYP,
			FOLLOW_SYBTYP_in_type248);
		...
		_last = (CommonTree) input.LT(1);
		BNKTYP21 = (CommonTree) match(input, BNKTYP,
			FOLLOW_BNKTYP_in_type252);
		...
		_last = (CommonTree) input.LT(1);
		SRTTYP22 = (CommonTree) match(input, SRTTYP,
			FOLLOW_SRTTYP_in_type256);
		...
		_last = (CommonTree) input.LT(1);
		ENDTYP23 = (CommonTree) match(input, ENDTYP,
			FOLLOW_ENDTYP_in_type260);
    ...
    public final MOVInterpreterTree.token_return token()
	    throws RecognitionException {
	...
	try {
		...
		_last = (CommonTree) input.LT(1);
		TOKEN24 = (CommonTree) match(input, TOKEN,
			FOLLOW_TOKEN_in_token272);
    ...
    // ;
    public final MOVInterpreterTree.where_return where()
	    throws RecognitionException {
	...
	try {
		...
		retval.spos = (start25 != null ? start25.pos : 0);
		retval.epos = (end26 != null ? end26.pos : 0);
    ...
    // MOVInterpreterTree.g:77:1: scanningOrder returns [String value] : ( FRMB
    // | FRME );
    public final MOVInterpreterTree.scanningOrder_return scanningOrder()
	    throws RecognitionException {
	...
	try {
		...
		_last = (CommonTree) input.LT(1);
		FRMB27 = (CommonTree) match(input, FRMB,
			FOLLOW_FRMB_in_scanningOrder302);
		...
		_last = (CommonTree) input.LT(1);
		FRME28 = (CommonTree) match(input, FRME,
			FOLLOW_FRME_in_scanningOrder306);
    ...
    // $ANTLR start "start"
    // MOVInterpreterTree.g:80:1: start returns [int pos] : scanningOrder r=
    // swherequantifier[$scanningOrder.value] ;
    public final MOVInterpreterTree.start_return start()
	    throws RecognitionException {
	...
	try {
	    // MOVInterpreterTree.g:80:24: ( scanningOrder r=
	    // swherequantifier[$scanningOrder.value] )
	    // MOVInterpreterTree.g:80:27: scanningOrder r=
	    // swherequantifier[$scanningOrder.value]
	    {
		root_0 = (CommonTree) adaptor.nil();
		...
		r = swherequantifier((scanningOrder29 != null ? scanningOrder29.value
			: null));
    ...
    // $ANTLR start "end"
    // MOVInterpreterTree.g:81:1: end returns [int pos] : scanningOrder r=
    // ewherequantifier[$scanningOrder.value] ;
    public final MOVInterpreterTree.end_return end()
	    throws RecognitionException {
	...
	try {
	    // MOVInterpreterTree.g:81:22: ( scanningOrder r=
	    // ewherequantifier[$scanningOrder.value] )
	    // MOVInterpreterTree.g:81:25: scanningOrder r=
	    // ewherequantifier[$scanningOrder.value]
	    {
		root_0 = (CommonTree) adaptor.nil();
		...
		r = ewherequantifier((scanningOrder30 != null ? scanningOrder30.value
			: null));
    ...
    // $ANTLR start "dest"
    // MOVInterpreterTree.g:82:1: dest returns [int pos] : scanningOrder r=
    // dwherequantifier[$scanningOrder.value] ;
    public final MOVInterpreterTree.dest_return dest()
	    throws RecognitionException {
	...
	try {
	    // MOVInterpreterTree.g:82:23: ( scanningOrder r=
	    // dwherequantifier[$scanningOrder.value] )
	    // MOVInterpreterTree.g:82:26: scanningOrder r=
	    // dwherequantifier[$scanningOrder.value]
	    {
		root_0 = (CommonTree) adaptor.nil();
		...
		r = dwherequantifier((scanningOrder31 != null ? scanningOrder31.value
			: null));
    ...
    // MOVInterpreterTree.g:83:1: dwherequantifier[String order] returns [int
    // xpos] : ( FST (q= INCLD )? x= dtokenspec | LST (p= INCLD )? y= dtokenspec
    // | dnum );
    public final MOVInterpreterTree.dwherequantifier_return dwherequantifier(
	    String order) throws RecognitionException {
	...
	try {
	    // MOVInterpreterTree.g:84:2: ( FST (q= INCLD )? x= dtokenspec | LST
	    // (p= INCLD )? y= dtokenspec | dnum )
	    int alt11 = 3;
	    switch (input.LA(1)) {
	    case FST: {
		alt11 = 1;
		...
		_last = (CommonTree) input.LT(1);
		FST32 = (CommonTree) match(input, FST,
			FOLLOW_FST_in_dwherequantifier377);
		...
		{
		    _last = (CommonTree) input.LT(1);
		    q = (CommonTree) match(input, INCLD,
			    FOLLOW_INCLD_in_dwherequantifier381);
		...
		retval.xpos = this.ruler.evalPos(
			(FST32 != null ? FST32.getText() : null)
				+ (q != null ? q.getText() : null),
			(x != null ? x.res : null), order);
		...
		_last = (CommonTree) input.LT(1);
		LST33 = (CommonTree) match(input, LST,
			FOLLOW_LST_in_dwherequantifier391);
		...
		{
		    _last = (CommonTree) input.LT(1);
		    p = (CommonTree) match(input, INCLD,
			    FOLLOW_INCLD_in_dwherequantifier395);
		...
		retval.xpos = this.ruler.evalPos(
			(LST33 != null ? LST33.getText() : null)
				+ (p != null ? p.getText() : null),
			(x != null ? x.res : null), order);
		...
		retval.xpos = this.ruler.evalPos(
			(dnum34 != null ? (input.getTokenStream().toString(
				input.getTreeAdaptor().getTokenStartIndex(
					dnum34.start), input.getTreeAdaptor()
					.getTokenStopIndex(dnum34.start)))
				: null), null, order);
    ...
    // MOVInterpreterTree.g:85:1: swherequantifier[String order] returns [int
    // xpos] : ( FST (q= INCLD )? x= stokenspec | LST (p= INCLD )? y= stokenspec
    // | snum );
    public final MOVInterpreterTree.swherequantifier_return swherequantifier(
	    String order) throws RecognitionException {
	...
	try {
	    // MOVInterpreterTree.g:86:2: ( FST (q= INCLD )? x= stokenspec | LST
	    // (p= INCLD )? y= stokenspec | snum )
	    int alt14 = 3;
	    switch (input.LA(1)) {
	    case FST: {
		alt14 = 1;
		...
		_last = (CommonTree) input.LT(1);
		FST35 = (CommonTree) match(input, FST,
			FOLLOW_FST_in_swherequantifier420);
		...
		// MOVInterpreterTree.g:86:9: q= INCLD
		{
		    _last = (CommonTree) input.LT(1);
		    q = (CommonTree) match(input, INCLD,
			    FOLLOW_INCLD_in_swherequantifier424);
		    q_tree = (CommonTree) adaptor.dupNode(q);
		...
		_last = (CommonTree) input.LT(1);
		LST36 = (CommonTree) match(input, LST,
			FOLLOW_LST_in_swherequantifier434);
		...
		// MOVInterpreterTree.g:86:99: p= INCLD
		{
		    _last = (CommonTree) input.LT(1);
		    p = (CommonTree) match(input, INCLD,
			    FOLLOW_INCLD_in_swherequantifier438);
		    p_tree = (CommonTree) adaptor.dupNode(p);
		...
		retval.xpos = this.ruler.evalPos((snum37 != null ? snum37.x
			: null), null, order);
    ...
    // MOVInterpreterTree.g:87:1: ewherequantifier[String order] returns [int
    // xpos] : ( FST (q= INCLD )? x= etokenspec | LST (p= INCLD )? y= etokenspec
    // | tnum );
    public final MOVInterpreterTree.ewherequantifier_return ewherequantifier(
	    String order) throws RecognitionException {
	...
	try {
	    // MOVInterpreterTree.g:88:2: ( FST (q= INCLD )? x= etokenspec | LST
	    // (p= INCLD )? y= etokenspec | tnum )
	    int alt17 = 3;
	    switch (input.LA(1)) {
	    case FST: {
		alt17 = 1;
		...
		_last = (CommonTree) input.LT(1);
		FST38 = (CommonTree) match(input, FST,
			FOLLOW_FST_in_ewherequantifier463);
		...
		// MOVInterpreterTree.g:88:9: q= INCLD
		{
		    _last = (CommonTree) input.LT(1);
		    q = (CommonTree) match(input, INCLD,
			    FOLLOW_INCLD_in_ewherequantifier467);
		    q_tree = (CommonTree) adaptor.dupNode(q);
		...
		_last = (CommonTree) input.LT(1);
		LST39 = (CommonTree) match(input, LST,
			FOLLOW_LST_in_ewherequantifier477);
		...
		// MOVInterpreterTree.g:88:99: p= INCLD
		{
		    _last = (CommonTree) input.LT(1);
		    p = (CommonTree) match(input, INCLD,
			    FOLLOW_INCLD_in_ewherequantifier481);
		    p_tree = (CommonTree) adaptor.dupNode(p);
		...
		retval.xpos = this.ruler.evalPos((tnum40 != null ? tnum40.x
			: null), null, order);
    ...
    public final MOVInterpreterTree.snum_return snum()
	    throws RecognitionException {
    ...
    public final MOVInterpreterTree.tnum_return tnum()
	    throws RecognitionException {
    ...
    public final MOVInterpreterTree.dnum_return dnum()
	    throws RecognitionException {
    ...
    public static final BitSet FOLLOW_operator_in_rule71 = new BitSet(
	    new long[] { 0x00000000001F00B0L });
    public static final BitSet FOLLOW_what_in_rule73 = new BitSet(
	    new long[] { 0x0000000000000300L });
    public static final BitSet FOLLOW_where_in_rule75 = new BitSet(
	    new long[] { 0x0000000000000300L });
    public static final BitSet FOLLOW_dest_in_rule77 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_tokenspec_in_what90 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_ANYTOKS_in_what93 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_tokenspec113 = new BitSet(
	    new long[] { 0x00000000001F00A2L });
    public static final BitSet FOLLOW_singletokenspec_in_tokenspec117 = new BitSet(
	    new long[] { 0x00000000001F00A2L });
    public static final BitSet FOLLOW_singletokenspec_in_stokenspec139 = new BitSet(
	    new long[] { 0x00000000001F00A2L });
    public static final BitSet FOLLOW_singletokenspec_in_stokenspec143 = new BitSet(
	    new long[] { 0x00000000001F00A2L });
    public static final BitSet FOLLOW_singletokenspec_in_etokenspec165 = new BitSet(
	    new long[] { 0x00000000001F00A2L });
    public static final BitSet FOLLOW_singletokenspec_in_etokenspec169 = new BitSet(
	    new long[] { 0x00000000001F00A2L });
    public static final BitSet FOLLOW_singletokenspec_in_dtokenspec191 = new BitSet(
	    new long[] { 0x00000000001F00A2L });
    public static final BitSet FOLLOW_singletokenspec_in_dtokenspec195 = new BitSet(
	    new long[] { 0x00000000001F00A2L });
    public static final BitSet FOLLOW_token_in_singletokenspec210 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_type_in_singletokenspec213 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_MOV_in_operator226 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUMTYP_in_type240 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_WRDTYP_in_type244 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_SYBTYP_in_type248 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_BNKTYP_in_type252 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_SRTTYP_in_type256 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_ENDTYP_in_type260 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_TOKEN_in_token272 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_start_in_where286 = new BitSet(
	    new long[] { 0x0000000000000300L });
    public static final BitSet FOLLOW_end_in_where288 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_FRMB_in_scanningOrder302 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_FRME_in_scanningOrder306 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_scanningOrder_in_start320 = new BitSet(
	    new long[] { 0x0000000000009400L });
    public static final BitSet FOLLOW_swherequantifier_in_start324 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_scanningOrder_in_end338 = new BitSet(
	    new long[] { 0x0000000000009400L });
    public static final BitSet FOLLOW_ewherequantifier_in_end342 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_scanningOrder_in_dest356 = new BitSet(
	    new long[] { 0x0000000000009400L });
    public static final BitSet FOLLOW_dwherequantifier_in_dest360 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_FST_in_dwherequantifier377 = new BitSet(
	    new long[] { 0x00000000001F08A0L });
    public static final BitSet FOLLOW_INCLD_in_dwherequantifier381 = new BitSet(
	    new long[] { 0x00000000001F00A0L });
    public static final BitSet FOLLOW_dtokenspec_in_dwherequantifier386 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_LST_in_dwherequantifier391 = new BitSet(
	    new long[] { 0x00000000001F08A0L });
    public static final BitSet FOLLOW_INCLD_in_dwherequantifier395 = new BitSet(
	    new long[] { 0x00000000001F00A0L });
    public static final BitSet FOLLOW_dtokenspec_in_dwherequantifier400 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_dnum_in_dwherequantifier404 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_FST_in_swherequantifier420 = new BitSet(
	    new long[] { 0x00000000001F08A0L });
    public static final BitSet FOLLOW_INCLD_in_swherequantifier424 = new BitSet(
	    new long[] { 0x00000000001F00A0L });
    public static final BitSet FOLLOW_stokenspec_in_swherequantifier429 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_LST_in_swherequantifier434 = new BitSet(
	    new long[] { 0x00000000001F08A0L });
    public static final BitSet FOLLOW_INCLD_in_swherequantifier438 = new BitSet(
	    new long[] { 0x00000000001F00A0L });
    public static final BitSet FOLLOW_stokenspec_in_swherequantifier443 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_snum_in_swherequantifier447 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_FST_in_ewherequantifier463 = new BitSet(
	    new long[] { 0x00000000001F08A0L });
    public static final BitSet FOLLOW_INCLD_in_ewherequantifier467 = new BitSet(
	    new long[] { 0x00000000001F00A0L });
    public static final BitSet FOLLOW_etokenspec_in_ewherequantifier472 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_LST_in_ewherequantifier477 = new BitSet(
	    new long[] { 0x00000000001F08A0L });
    public static final BitSet FOLLOW_INCLD_in_ewherequantifier481 = new BitSet(
	    new long[] { 0x00000000001F00A0L });
    public static final BitSet FOLLOW_etokenspec_in_ewherequantifier486 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_tnum_in_ewherequantifier490 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUM_in_snum502 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUM_in_tnum513 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUM_in_dnum524 = new BitSet(
	    new long[] { 0x0000000000000002L });
