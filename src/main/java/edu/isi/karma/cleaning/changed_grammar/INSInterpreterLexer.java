...
public class INSInterpreterLexer extends Lexer {
	...
	// INSInterpreter.g:1:8: ( ANYNUM | ANYTOK | ANYTYP | BNKTYP | ENDTYP |
	// FRMB | FRME | FST | INCLD | INS | LST | NUMTYP | SRTTYP | SYBTYP |
	// WRDTYP | TOKEN | NEWLINE | WS | NUM )
	int alt5 = 19;
	switch (input.LA(1)) {
	case 'a': {
	    alt5 = 1;
	...
	case 'f': {
		...
		NoViableAltException nvae = new NoViableAltException("", 5, 5,
			input);
	...
	case 'S': {
		...
		NoViableAltException nvae = new NoViableAltException("", 5, 9,
			input);
