...
public class MOVInterpreterParser extends Parser {
	...
	return MOVInterpreterParser.tokenNames;
    }

    public String getGrammarFileName() {
	return "MOVInterpreter.g";
    }
    ...
    public final MOVInterpreterParser.rule_return rule()
    ...
    public final MOVInterpreterParser.what_return what()
	    throws RecognitionException {
	...
	try {
		...
		ANYTOKS6 = (Token) match(input, ANYTOKS,
			FOLLOW_ANYTOKS_in_what178);
		ANYTOKS6_tree = (Object) adaptor.create(ANYTOKS6);
    ...
    // MOVInterpreter.g:42:1: tokenspec : ( singletokenspec | singletokenspec
    // tokenspec );
    public final MOVInterpreterParser.tokenspec_return tokenspec()
	    throws RecognitionException {
	...
	try {
	    // MOVInterpreter.g:42:11: ( singletokenspec | singletokenspec
	    // tokenspec )
	    int alt2 = 2;
	    ...
	    } else if ((LA2_0 == BNKTYP || LA2_0 == ENDTYP
		    || (LA2_0 >= NUMTYP && LA2_0 <= SYBTYP) || LA2_0 == WRDTYP)) {
    ...
    // MOVInterpreter.g:43:1: stokenspec : ( singletokenspec | singletokenspec
    // stokenspec );
    public final MOVInterpreterParser.stokenspec_return stokenspec()
	    throws RecognitionException {
	...
	try {
	    // MOVInterpreter.g:43:12: ( singletokenspec | singletokenspec
	    // stokenspec )
	    int alt3 = 2;
	    ...
	    } else if ((LA3_0 == BNKTYP || LA3_0 == ENDTYP
		    || (LA3_0 >= NUMTYP && LA3_0 <= SYBTYP) || LA3_0 == WRDTYP)) {
    ...
    // MOVInterpreter.g:44:1: etokenspec : ( singletokenspec | singletokenspec
    // etokenspec );
    public final MOVInterpreterParser.etokenspec_return etokenspec()
	    throws RecognitionException {
	...
	try {
	    // MOVInterpreter.g:44:12: ( singletokenspec | singletokenspec
	    // etokenspec )
	    int alt4 = 2;
	    ...
	    } else if ((LA4_0 == BNKTYP || LA4_0 == ENDTYP
		    || (LA4_0 >= NUMTYP && LA4_0 <= SYBTYP) || LA4_0 == WRDTYP)) {
    ...
    // MOVInterpreter.g:45:1: dtokenspec : ( singletokenspec | singletokenspec
    // dtokenspec );
    public final MOVInterpreterParser.dtokenspec_return dtokenspec()
	    throws RecognitionException {
	...
	try {
	    // MOVInterpreter.g:45:12: ( singletokenspec | singletokenspec
	    // dtokenspec )
	    int alt5 = 2;
	    ...
	    } else if ((LA5_0 == BNKTYP || LA5_0 == ENDTYP
		    || (LA5_0 >= NUMTYP && LA5_0 <= SYBTYP) || LA5_0 == WRDTYP)) {
    ...
    public final MOVInterpreterParser.singletokenspec_return singletokenspec()
	    throws RecognitionException {
    ...
    public final MOVInterpreterParser.operator_return operator()
	    throws RecognitionException {
	...
	try {
		...
		MOV21_tree = (Object) adaptor.create(MOV21);
    ...
    // $ANTLR start "type"
    // MOVInterpreter.g:52:1: type : ( NUMTYP | WRDTYP | SYBTYP | BNKTYP |
    // SRTTYP | ENDTYP );
    public final MOVInterpreterParser.type_return type()
	    throws RecognitionException {
	...
	try {
	    // MOVInterpreter.g:52:7: ( NUMTYP | WRDTYP | SYBTYP | BNKTYP |
	    // SRTTYP | ENDTYP )
	    // MOVInterpreter.g:
	    {
		root_0 = (Object) adaptor.nil();
		...
		if (input.LA(1) == BNKTYP || input.LA(1) == ENDTYP
			|| (input.LA(1) >= NUMTYP && input.LA(1) <= SYBTYP)
			|| input.LA(1) == WRDTYP) {
		    input.consume();
    ...
    public final MOVInterpreterParser.token_return token()
	    throws RecognitionException {
	...
	try {
		...
		TOKEN23_tree = (Object) adaptor.create(TOKEN23);
    ...
    public final MOVInterpreterParser.where_return where()
	    throws RecognitionException {
    ...
    public final MOVInterpreterParser.scanningOrder_return scanningOrder()
	    throws RecognitionException {
    ...
    public final MOVInterpreterParser.start_return start()
	    throws RecognitionException {
    ...
    public final MOVInterpreterParser.end_return end()
	    throws RecognitionException {
    ...
    public final MOVInterpreterParser.dest_return dest()
	    throws RecognitionException {
    ...
    // MOVInterpreter.g:63:1: dwherequantifier : ( FST ( INCLD )? dtokenspec |
    // dnum );
    public final MOVInterpreterParser.dwherequantifier_return dwherequantifier()
	    throws RecognitionException {
	...
	try {
		...
		FST33 = (Token) match(input, FST,
			FOLLOW_FST_in_dwherequantifier342);
		FST33_tree = (Object) adaptor.create(FST33);
		...
		// MOVInterpreter.g:63:24: INCLD
		{
		    INCLD34 = (Token) match(input, INCLD,
			    FOLLOW_INCLD_in_dwherequantifier344);
		    INCLD34_tree = (Object) adaptor.create(INCLD34);
    ...
    // MOVInterpreter.g:64:1: swherequantifier : ( FST ( INCLD )? stokenspec |
    // snum );
    public final MOVInterpreterParser.swherequantifier_return swherequantifier()
	    throws RecognitionException {
	...
	try {
		...
		FST37 = (Token) match(input, FST,
			FOLLOW_FST_in_swherequantifier356);
		FST37_tree = (Object) adaptor.create(FST37);
		...
		// MOVInterpreter.g:64:24: INCLD
		{
		    INCLD38 = (Token) match(input, INCLD,
			    FOLLOW_INCLD_in_swherequantifier358);
		    INCLD38_tree = (Object) adaptor.create(INCLD38);
    ...
    // MOVInterpreter.g:65:1: ewherequantifier : ( FST ( INCLD )? etokenspec |
    // tnum );
    public final MOVInterpreterParser.ewherequantifier_return ewherequantifier()
	    throws RecognitionException {
	...
	try {
		...
		FST41 = (Token) match(input, FST,
			FOLLOW_FST_in_ewherequantifier370);
		FST41_tree = (Object) adaptor.create(FST41);
		...
		// MOVInterpreter.g:65:24: INCLD
		{
		    INCLD42 = (Token) match(input, INCLD,
			    FOLLOW_INCLD_in_ewherequantifier372);
		    INCLD42_tree = (Object) adaptor.create(INCLD42);
    ...
    public final MOVInterpreterParser.snum_return snum()
	    throws RecognitionException {
    ...
    public final MOVInterpreterParser.tnum_return tnum()
	    throws RecognitionException {
	...
	try {
		...
		NUM46_tree = (Object) adaptor.create(NUM46);
    ...
    public final MOVInterpreterParser.dnum_return dnum()
	    throws RecognitionException {
	...
	try {
		...
		NUM47_tree = (Object) adaptor.create(NUM47);
    ...
    public static final BitSet FOLLOW_operator_in_rule163 = new BitSet(
	    new long[] { 0x00000000001F00B0L });
    public static final BitSet FOLLOW_what_in_rule165 = new BitSet(
	    new long[] { 0x0000000000000300L });
    public static final BitSet FOLLOW_where_in_rule167 = new BitSet(
	    new long[] { 0x0000000000000300L });
    public static final BitSet FOLLOW_dest_in_rule169 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_tokenspec_in_what176 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_ANYTOKS_in_what178 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_tokenspec188 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_tokenspec191 = new BitSet(
	    new long[] { 0x00000000001F00A0L });
    public static final BitSet FOLLOW_tokenspec_in_tokenspec193 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_stokenspec200 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_stokenspec203 = new BitSet(
	    new long[] { 0x00000000001F00A0L });
    public static final BitSet FOLLOW_stokenspec_in_stokenspec205 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_etokenspec212 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_etokenspec215 = new BitSet(
	    new long[] { 0x00000000001F00A0L });
    public static final BitSet FOLLOW_etokenspec_in_etokenspec217 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_dtokenspec224 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_dtokenspec227 = new BitSet(
	    new long[] { 0x00000000001F00A0L });
    public static final BitSet FOLLOW_dtokenspec_in_dtokenspec229 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_token_in_singletokenspec236 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_type_in_singletokenspec238 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_MOV_in_operator247 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_TOKEN_in_token278 = new BitSet(
	    new long[] { 0x0000000000000002L });
    ...
    public static final BitSet FOLLOW_end_in_where290 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_scanningOrder_in_start311 = new BitSet(
	    new long[] { 0x0000000000008400L });
    public static final BitSet FOLLOW_swherequantifier_in_start313 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_scanningOrder_in_end322 = new BitSet(
	    new long[] { 0x0000000000008400L });
    public static final BitSet FOLLOW_ewherequantifier_in_end324 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_scanningOrder_in_dest333 = new BitSet(
	    new long[] { 0x0000000000008400L });
    public static final BitSet FOLLOW_dwherequantifier_in_dest335 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_FST_in_dwherequantifier342 = new BitSet(
	    new long[] { 0x00000000001F08A0L });
    public static final BitSet FOLLOW_INCLD_in_dwherequantifier344 = new BitSet(
	    new long[] { 0x00000000001F00A0L });
    public static final BitSet FOLLOW_dtokenspec_in_dwherequantifier347 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_dnum_in_dwherequantifier349 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_FST_in_swherequantifier356 = new BitSet(
	    new long[] { 0x00000000001F08A0L });
    public static final BitSet FOLLOW_INCLD_in_swherequantifier358 = new BitSet(
	    new long[] { 0x00000000001F00A0L });
    public static final BitSet FOLLOW_stokenspec_in_swherequantifier361 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_snum_in_swherequantifier363 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_FST_in_ewherequantifier370 = new BitSet(
	    new long[] { 0x00000000001F08A0L });
    public static final BitSet FOLLOW_INCLD_in_ewherequantifier372 = new BitSet(
	    new long[] { 0x00000000001F00A0L });
    public static final BitSet FOLLOW_etokenspec_in_ewherequantifier375 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_tnum_in_ewherequantifier377 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUM_in_snum386 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUM_in_tnum395 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUM_in_dnum404 = new BitSet(
	    new long[] { 0x0000000000000002L });
