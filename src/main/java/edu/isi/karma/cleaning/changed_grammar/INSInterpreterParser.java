...
public class INSInterpreterParser extends Parser {
	...
	return INSInterpreterParser.tokenNames;
    }

    public String getGrammarFileName() {
	return "INSInterpreter.g";
    }
    ...
    public final INSInterpreterParser.rule_return rule()
    ...
    public final INSInterpreterParser.what_return what()
	    throws RecognitionException {
    ...
    public final INSInterpreterParser.tokenspec_return tokenspec()
	    throws RecognitionException {
    ...
    // ;
    public final INSInterpreterParser.dtokenspec_return dtokenspec()
	    throws RecognitionException {
    ...
    public final INSInterpreterParser.singletokenspec_return singletokenspec()
	    throws RecognitionException {
    ...
    // $ANTLR start "type"
    // INSInterpreter.g:51:1: type : ( NUMTYP | WRDTYP | SYBTYP | BNKTYP |
    // SRTTYP | ENDTYP );
    public final INSInterpreterParser.type_return type()
	    throws RecognitionException {
	...
	try {
	    // INSInterpreter.g:51:6: ( NUMTYP | WRDTYP | SYBTYP | BNKTYP |
	    // SRTTYP | ENDTYP )
	    // INSInterpreter.g:
	    {
		root_0 = (Object) adaptor.nil();
    ...
    public final INSInterpreterParser.operator_return operator()
	    throws RecognitionException {
	...
	try {
		...
		INS12_tree = (Object) adaptor.create(INS12);
    ...
    public final INSInterpreterParser.token_return token()
	    throws RecognitionException {
	...
	try {
		...
		TOKEN13_tree = (Object) adaptor.create(TOKEN13);
    ...
    public final INSInterpreterParser.scanningOrder_return scanningOrder()
	    throws RecognitionException {
    ...
    public final INSInterpreterParser.dest_return dest()
	    throws RecognitionException {
    ...
    // INSInterpreter.g:65:1: dwherequantifier : ( FST ( INCLD )? dtokenspec |
    // LST ( INCLD )? dtokenspec | dnum );
    public final INSInterpreterParser.dwherequantifier_return dwherequantifier()
	    throws RecognitionException {
	...
	try {
	    // INSInterpreter.g:66:2: ( FST ( INCLD )? dtokenspec | LST ( INCLD
	    // )? dtokenspec | dnum )
	    int alt6 = 3;
	    switch (input.LA(1)) {
	    case FST: {
		...
		FST17 = (Token) match(input, FST,
			FOLLOW_FST_in_dwherequantifier318);
		FST17_tree = (Object) adaptor.create(FST17);
		...
		// INSInterpreter.g:66:8: INCLD
		{
		    INCLD18 = (Token) match(input, INCLD,
			    FOLLOW_INCLD_in_dwherequantifier320);
		    INCLD18_tree = (Object) adaptor.create(INCLD18);
		...
		LST20 = (Token) match(input, LST,
			FOLLOW_LST_in_dwherequantifier326);
		LST20_tree = (Object) adaptor.create(LST20);
		...
		// INSInterpreter.g:66:31: INCLD
		{
		    INCLD21 = (Token) match(input, INCLD,
			    FOLLOW_INCLD_in_dwherequantifier328);
		    INCLD21_tree = (Object) adaptor.create(INCLD21);
    ...
    public final INSInterpreterParser.dnum_return dnum()
	    throws RecognitionException {
	...
	try {
		...
		NUM24_tree = (Object) adaptor.create(NUM24);
    ...
    public static final BitSet FOLLOW_operator_in_rule182 = new BitSet(
	    new long[] { 0x00000000007C0280L });
    public static final BitSet FOLLOW_what_in_rule184 = new BitSet(
	    new long[] { 0x0000000000000C00L });
    public static final BitSet FOLLOW_dest_in_rule186 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_tokenspec_in_what195 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_singletokenspec_in_tokenspec206 = new BitSet(
	    new long[] { 0x00000000007C0282L });
    public static final BitSet FOLLOW_singletokenspec_in_tokenspec209 = new BitSet(
	    new long[] { 0x00000000007C0282L });
    public static final BitSet FOLLOW_singletokenspec_in_dtokenspec222 = new BitSet(
	    new long[] { 0x00000000007C0282L });
    public static final BitSet FOLLOW_singletokenspec_in_dtokenspec225 = new BitSet(
	    new long[] { 0x00000000007C0282L });
    ...
    public static final BitSet FOLLOW_type_in_singletokenspec238 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_INS_in_operator268 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_TOKEN_in_token278 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_scanningOrder_in_dest304 = new BitSet(
	    new long[] { 0x0000000000029000L });
    public static final BitSet FOLLOW_dwherequantifier_in_dest306 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_FST_in_dwherequantifier318 = new BitSet(
	    new long[] { 0x00000000007C2280L });
    public static final BitSet FOLLOW_INCLD_in_dwherequantifier320 = new BitSet(
	    new long[] { 0x00000000007C0280L });
    public static final BitSet FOLLOW_dtokenspec_in_dwherequantifier323 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_LST_in_dwherequantifier326 = new BitSet(
	    new long[] { 0x00000000007C2280L });
    public static final BitSet FOLLOW_INCLD_in_dwherequantifier328 = new BitSet(
	    new long[] { 0x00000000007C0280L });
    public static final BitSet FOLLOW_dtokenspec_in_dwherequantifier331 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_dnum_in_dwherequantifier334 = new BitSet(
	    new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_NUM_in_dnum343 = new BitSet(
	    new long[] { 0x0000000000000002L });
