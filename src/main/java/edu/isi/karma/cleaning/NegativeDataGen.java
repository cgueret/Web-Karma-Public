...
public class NegativeDataGen {
	...
	File dir = new File(
		"/Users/bowu/Research/dataclean/data/RuleData/rawdata/pairs/pos");
	...
	try {
		...
		if (f.getName().indexOf(".csv") == (f.getName().length() - 4)
		    ...
		    CSVWriter cw = new CSVWriter(new FileWriter(new File(
			    "/Users/bowu/Research/dataclean/data/RuleData/rawdata/pairs/neg/"
			...
			Vector<TNode> res = NegativeDataGen.randomEdit(r1.vec,
				r2.vec);
			String x = "";
