...
public class HTTPClientTest {
    ...
    public static void postData2(String data, URL endpoint, Writer output)
	    throws Exception {
	HttpURLConnection urlc = null;
	try {
	    urlc = (HttpURLConnection) endpoint.openConnection();
	    ...
	    OutputStreamWriter wr = new OutputStreamWriter(
		    urlc.getOutputStream(), CharEncoding.UTF_8);
	    wr.write(data);
	    wr.flush();
	...
	// postData( new
	// FileReader("C:\\Users\\mohsen\\Desktop\\karma\\input.rdf"), new
	// URL(endpoint), writer);
	// postData2( new String(xmlData.getBytes(CharEncoding.UTF_8)), new
	// URL(endpoint), writer);
    }
}
