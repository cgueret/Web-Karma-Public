...
public class LinkedApiRequestManager {
    ...
    public LinkedApiRequestManager(String serviceId, ResourceType resourceType,
	    String returnType, HttpServletResponse response) {
	this.serviceId = serviceId;
	this.serviceUri = Service.KARMA_SERVICE_PREFIX + serviceId
		+ (!serviceId.endsWith("#") ? "#" : "");
    ...
    public static void getServiceDescripton(String serviceID,
	    String responseLang, PrintWriter pw) {
