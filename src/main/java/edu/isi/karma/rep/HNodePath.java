...
public class HNodePath {
    ...
    // mariam
    /**
     * Returns the HNodePath as a String containing the column name of the child
     * node at the end.
     * 
     * @return the HNodePath as a String containing the column name of the child
     *         node at the end. Example: HN1/HN2/ColumnName
     */
    ...
    /**
     * Returns the HNodePath as a String containing column names instead of
     * HnodeIds
     * 
     * @return the HNodePath as a String containing column names instead of
     *         HnodeIds. Example: ColumnName1/ColumnName2
     */
