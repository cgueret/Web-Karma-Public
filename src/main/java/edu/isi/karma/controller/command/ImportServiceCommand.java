...
public class ImportServiceCommand extends Command {
    ...
    protected ImportServiceCommand(String id, String interactionType,
	    String ServiceUrl, String sourceName) {
	super(id);
	...
	try {
		...
		return new UpdateContainer(new AbstractUpdate() {
			...
			try {
				...
				dataRows.put(((JSONObject) availableSourcesArray
					.get(i)).get("SourceName"));
			    }
		...
		// import a source
		String url = ServiceUrl + "/GetSampleData?sourceName="
			+ sourceName;
		...
		// JsonImport imp = new JsonImport(wsOutput, sourceName,
		// vWorkspace.getWorkspace());
		JsonImport imp = new JsonImport(json, sourceName,
			vWorkspace.getWorkspace());
     ...
     * @throws IOException
     */
    private String getFromUrl(String url) throws UnsupportedEncodingException,
	    IOException {
