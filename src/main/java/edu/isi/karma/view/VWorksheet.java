...
public class VWorksheet extends ViewEntity {
	...
	pw.println(newPref
		+ JSONUtil.json(WorksheetDataUpdate.JsonKeys.worksheetId,
			getId()));

	pw.println(newPref
		+ JSONUtil
			.jsonStartList(WorksheetHeadersUpdate.JsonKeys.columns));
	...
	pw.println(newPref
		+ JSONUtil.json(WorksheetListUpdate.JsonKeys.worksheetId,
			getId()));
	pw.println(newPref
		+ JSONUtil.json(WorksheetListUpdate.JsonKeys.isUpToDate,
			upToDate));
	pw.println(newPref
		+ JSONUtil.json(WorksheetListUpdate.JsonKeys.isCollapsed,
			collapsed));
