...
public class ViewFactory {
    ...
    public void updateWorksheet(String vWorksheetId, Worksheet worksheet,
	    List<HNodePath> columns, VWorkspace vWorkspace) {
	VWorksheet vw = new VWorksheet(vWorksheetId, worksheet, columns,
		vWorkspace);
	...
	vw.setColumnCoordinatesSet(new ColumnCoordinateSet(hHtree,
		new ColspanMap(hHtree)));
