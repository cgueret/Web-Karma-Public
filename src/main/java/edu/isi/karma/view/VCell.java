...
public class VCell {
	...
	pw.print(JSONUtil.json(WorksheetDataUpdate.JsonKeys.isFirstRow,
		isFirstRow));
	pw.print(JSONUtil.json(WorksheetDataUpdate.JsonKeys.isLastRow,
		isLastRow));
	...
	if (isLastRow && !tablePager.isAllRowsShown()
	    ...
	    pw.println(newPref
		    + JSONUtil
			    .jsonStartObject(WorksheetDataUpdate.JsonKeys.pager));
