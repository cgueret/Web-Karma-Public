...
public class VColumnHeader {
    ...
    public VColumnHeader(String hNodeId, String columnNameFull,
	    String columnNameShort) {
	...
	pw.print(prefix + "{ ");
	pw.print(JSONUtil.json(WorksheetHeadersUpdate.JsonKeys.path,
		hNodePathId));
	pw.print(JSONUtil.json(WorksheetHeadersUpdate.JsonKeys.columnNameFull,
		columnNameFull));
	pw.print(JSONUtil.jsonLast(
		WorksheetHeadersUpdate.JsonKeys.columnNameShort,
		columnNameShort));
	pw.print(" }");
	if (generateComma) {
	    pw.println(" ,");
