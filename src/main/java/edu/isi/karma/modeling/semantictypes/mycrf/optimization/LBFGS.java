...
/**
 * This class implements limited memory BFGS. It generates the next gradient to
 * follow based on previous values of the weights and also previous gradients.
 * 
 * @author amangoel
 * 
 */
public class LBFGS {
	...
	if (iter == 1) {
	    ...
	    int ilMax = s.size() < Constants.MEMORY_FOR_L_BFGS ? s.size()
		    : Constants.MEMORY_FOR_L_BFGS;
