...
public class DBTable {
    ...
    /**
     * @param row
     *            - a list of strings that represent the values in a row This
     *            method adds the supplied row at the end of the tableData list
     *            of rows. It makes sure that the number of items in the list =
     *            numColumns
     */
    public void addRow(List<String> row) {
	if (row.size() != numColumns) {
	    Prnt.endIt("Number of items in the supplied row = " + row.size()
		    + " is not equal to the number of columns = " + numColumns
		    + " in the table. Exiting.");
	} else {
    ...
    /**
     * @param col
     *            The column index for which the values are required.
     * @param columnValues
