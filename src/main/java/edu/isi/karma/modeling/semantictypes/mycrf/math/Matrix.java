...
/**
 * This class represents matrices and vectors. It is primarily used to perform
 * vector computations, such as, addition, dot product, and scalar
 * multiplication.
 * 
 * @author amangoel
 * 
...
public class Matrix {
	...
	for (int row = 0; row < numOfRows; row++) {
		...
		for (int i = 0; i < numOfCols; i++) {
		    resultMatrix.data[row][col] += data[row][i]
			    * otherMatrix.data[i][col];
		}
	    }
	}
	return resultMatrix;
