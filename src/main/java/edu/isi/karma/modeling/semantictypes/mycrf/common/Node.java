...
/**
 * This class defined the nodes used in graphs. It stores the features of the
 * item that the node represents, a field or a token.
 * 
 * @author amangoel
 * 
 */
public class Node {
	...
	String levelName = type == Constants.FIELD_TYPE ? "TopLevel"
		: "BottomLevel";
