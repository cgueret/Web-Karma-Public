...
/**
 * This class represents global information used while creating graphs or
...
public class GlobalDataFieldOnly extends GlobalDataAbstract {
	...
	error = -error
		+ Matrix.dotProduct(crfModel.weights, crfModel.weights)
		/ (2 * Constants.STANDARD_DEVIATION * Constants.STANDARD_DEVIATION);
