...
public class GraphUtil {
    ...
    public static DirectedGraph<Vertex, LabeledWeightedEdge> asDirectedGraph(
	    UndirectedGraph<Vertex, LabeledWeightedEdge> undirectedGraph) {

	DirectedGraph<Vertex, LabeledWeightedEdge> g = new DirectedWeightedMultigraph<Vertex, LabeledWeightedEdge>(
