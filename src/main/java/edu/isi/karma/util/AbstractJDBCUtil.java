...
public abstract class AbstractJDBCUtil {
    ...
    public abstract ArrayList<ArrayList<String>> getDataForLimitedRows(
	    DBType dbType, String hostname, int portnumber, String username,
	    String password, String tableName, String dBorSIDName, int rowCount)
	    throws SQLException, ClassNotFoundException;

    public abstract ArrayList<String> getListOfTables(Connection conn)
	    throws SQLException, ClassNotFoundException;

    public Connection getConnection(String driver, String connectString)
	    throws SQLException, ClassNotFoundException {
    ...
    public Connection getConnection(String hostname, int portnumber,
	...
	logger.debug("Connect to:" + hostname + ":" + portnumber + "/"
		+ dBorSIDName);
    ...
    public ArrayList<ArrayList<String>> getDataForTable(DBType dbType,
	    String hostname, int portnumber, String username, String password,
	    String tableName, String dBorSIDName) throws SQLException,
    ...
    public ArrayList<ArrayList<String>> getDataForTable(Connection conn,
    ...
    protected ArrayList<ArrayList<String>> parseResultSetIntoArrayListOfRows(
     ...
     * @param tableName
     * @param conn
     * @return true if given table exists in DB; false otherwise.
     * @throws SQLException
