...
public class Attribute {
    ...
    public Attribute(String id, String baseUri, String name, String ioType,
    ...
    public Attribute(String id, String baseUri, String name, String ioType,
	    AttributeRequirement requirement, String groundedIn) {
	this.baseUri = baseUri;
	this.id = id;
	this.name = name;
	this.ioType = ioType;
	...
	// if (this.hNodeId != null && this.hNodeId.length() > 0)
	// System.out.println("hNodeId: " + this.hNodeId);
	// if (this.name != null && this.name.length() > 0)
	// System.out.println("name: " + this.name);
	// if (this.ioType != null && this.ioType.length() > 0)
	// System.out.println("IOType: " + this.ioType);
	// if (this.groundedIn != null && this.groundedIn.length() > 0)
	// System.out.println("groundedIn: " + this.groundedIn);
	// if (this.requirement != null) System.out.println("requirement: " +
	// this.requirement);
